...
# towards the camera.
BODIES = {
    # Licensed reference, full disc, frontal lighting -- so the illumination fit
    # has little to remove beyond limb darkening, and almost all of the near
    # hemisphere survives into the map intact.
    "dysnomia": dict(cx=624.3, cy=643.7, A=583.9, B=583.9, ang=0.0, sub=0.0),
}
