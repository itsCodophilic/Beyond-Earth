...
`)}var Rc=new K;function zc(e){q._getMatrix(Rc,q.workingColorSpace,e);let t=`mat3( ${Rc.elements.map(e=>e.toFixed(4))} )`;switch(q.getTransfer(e)){case ze:return[t,`LinearTransferOETF`];case Be:return[t,`sRGBTransferOETF`];default:return z(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function Bc(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`
...
`;function Hd(e){let t=e>>>0;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Ud(e){let t=Math.max(1e-7,e());return Math.sqrt(-2*Math.log(t))*Math.cos(Math.PI*2*e())}function Wd(e,t,n){let r=Math.min(1,Math.max(0,(e-t)/(n-t)));return r*r*r*(r*(r*6-15)+10)}function Gd({count:e,maximumRadius:t,pixelRatio:n}){let r=Hd(3495403806),i=new Float32Array(e*3),a=new Float32Array(e),o=new Float32Array(e),s=Array.from({length:14},(e,n)=>{let i=r()*Math.PI*2,a=U.lerp(-.92,.92,r()),o=U.lerp(110,t*.94,r()**.72),s=new G(Math.cos(i)*Math.sqrt(Math.max(0,1-a*a)),a,Math.sin(i)*Math.sqrt(Math.max(0,1-a*a))).normalize(),c=U.lerp(16,62,r()**.9);return{center:s.multiplyScalar(o),spreadX:c*U.lerp(.8,1.8,r()),spreadY:c*U.lerp(.7,1.45,r()),spreadZ:c*U.lerp(.8,1.8,r()),sizeBias:n<4?1.24:1}});for(let n=0;n<e;n+=1){let e=n*3,c=r();if(c<.38){let o=22+Math.sqrt(r())*(t*.74-22),s=r()*Math.PI*2;i[e]=Math.cos(s)*o,i[e+1]=U.clamp(Ud(r)*22,-88,88),i[e+2]=Math.sin(s)*o,a[n]=.42+r()**3.2*.9}else if(c<.68){let o=U.lerp(70,t,r()**.82),s=r()*Math.PI*2,c=U.lerp(-1,1,r()),l=Math.sqrt(Math.max(0,1-c*c));i[e]=Math.cos(s)*l*o,i[e+1]=c*o*U.lerp(.7,1,r()),i[e+2]=Math.sin(s)*l*o,a[n]=.4+r()**3.8*.82}else{let t=s[Math.floor(r()*s.length)];i[e]=t.center.x+Ud(r)*t.spreadX,i[e+1]=t.center.y+Ud(r)*t.spreadY,i[e+2]=t.center.z+Ud(r)*t.spreadZ,a[n]=(.46+r()**2.6*1.16)*t.sizeBias}o[n]=r()*Math.PI*2}let c=new wr;c.setAttribute(`position`,new Y(i,3)),c.setAttribute(`aSize`,new Y(a,1)),c.setAttribute(`aPhase`,new Y(o,1));let l=new Ta({uniforms:{uTime:{value:0},uPixelRatio:{value:n},uVisibility:{value:0},uReducedMotion:{value:0},uSunPosition:{value:new G}},vertexShader:Rd,fragmentShader:zd,transparent:!0,depthWrite:!1,depthTest:!0,blending:1,toneMapped:!0}),u=new qi(c,l);return u.name=`Clustered cosmic dust and interplanetary haze`,u.frustumCulled=!1,u.renderOrder=-12,{object:u,update({time:e,visibility:t,sunPosition:n,reducedMotion:r}){l.uniforms.uTime.value=e,l.uniforms.uVisibility.value=t,l.uniforms.uSunPosition.value.copy(n),l.uniforms.uReducedMotion.value=+!!r,r||(u.rotation.y=e*14e-5)},resize(e){l.uniforms.uPixelRatio.value=e},dispose(){c.dispose(),l.dispose()}}}var Kd=Object.freeze({sun:0,mercury:.08,venus:.16,earth:.25,moon:.29,mars:.36,asteroidBelt:.46,jupiter:.56,saturn:.67,uranus:.77,neptune:.86,kuiperBelt:.94,interstellar:1}),qd=Object.freeze({high:{maxPixelRatio:2,backgroundStars:3e4,galacticStars:26e3,parallaxStars:1300,heroStars:72,galaxies:96,dust:1180,heroStarsEnabled:!0,galaxiesEnabled:!0,zodiacalLightEnabled:!0,dustEnabled:!0},medium:{maxPixelRatio:1.5,backgroundStars:21e3,galacticStars:18500,parallaxStars:900,heroStars:52,galaxies:72,dust:760,heroStarsEnabled:!0,galaxiesEnabled:!0,zodiacalLightEnabled:!0,dustEnabled:!0},low:{maxPixelRatio:1.25,backgroundStars:12e3,galacticStars:1e4,parallaxStars:480,heroStars:28,galaxies:40,dust:280,heroStarsEnabled:!0,galaxiesEnabled:!0,zodiacalLightEnabled:!1,dustEnabled:!1}}),Jd=Object.freeze({radii:{dustMaximum:460,parallaxMinimum:680,parallaxMaximum:1120,galaxyShell:1880,heroStarShell:1940,backgroundStarShell:2060,milkyWayShell:2180},exposure:{innerSolar:1,middleSolar:1.04,outerSolar:1.08,interstellar:1.12},damping:{environment:3.5},milkyWayRotation:[.25,-.1,-.32]});function Yd({reducedMotion:e=!1}={}){let t=Math.min(window.innerWidth,window.innerHeight),n=navigator.hardwareConcurrency??8,r=navigator.deviceMemory??8,i=window.devicePixelRatio>2.2;return t<560||n<=4||r<=3?`low`:e||t<850||n<=6||r<=6||i?`medium`:`high`}var Xd=[`journeyProgress`,`solarInfluence`,`solarGlare`,`rendererExposure`,`directLightIntensity`,`sunApparentScale`,`starVisibility`,`heroStarVisibility`,`milkyWayVisibility`,`galaxyVisibility`,`dustVisibility`,`zodiacalGlow`,`debrisVisibility`,`backgroundContrast`,`bloomStrength`,`lensFlareStrength`],Zd=class{constructor(){this.journeyProgress=0,this.state=this.#e(0,{}),this.targets={...this.state}}setJourneyProgress(e){this.journeyProgress=Math.min(1,Math.max(0,e))}update(e){let t=this.#e(this.journeyProgress,this.targets),n=1-Math.exp(-Jd.damping.environment*e);return Xd.forEach(e=>{this.state[e]+=(t[e]-this.state[e])*n}),this.state}#e(e,t){let n=Wd(e,.24,.7),r=Wd(e,.6,.94),i=Wd(e,.82,1),a=1-Wd(e,.1,.97),o=Jd.exposure.innerSolar+n*(Jd.exposure.outerSolar-Jd.exposure.innerSolar)+i*(Jd.exposure.interstellar-Jd.exposure.outerSolar);return t.journeyProgress=e,t.solarInfluence=a,t.solarGlare=a*(1-r*.78),t.rendererExposure=o,t.directLightIntensity=.72+a*.28,t.sunApparentScale=.42+a*.58,t.starVisibility=.82+n*.12+r*.22+i*.12,t.heroStarVisibility=.28+n*.12+r*.34+i*.3,t.milkyWayVisibility=.18+n*.14+r*.28+i*.22,t.galaxyVisibility=.22+n*.16+r*.42+i*.38,t.dustVisibility=.01+a*.022+r*.026+i*.034,t.zodiacalGlow=.075*a*(1-r*.92),t.debrisVisibility=.16+n*.34,t.backgroundContrast=1.06+r*.15+i*.07,t.bloomStrength=.36+a*.18,t.lensFlareStrength=a*.5,t}},Qd=`
...
`,ef=new G(0,0,1),tf=new G,nf=new G,rf=new Tt,af=new Tt,of=new G,sf=new qt,cf=new J,lf=[{direction:[.66,.38,-.65],width:86,type:0,aspect:.44,brightness:1.22,color:[.72,.78,.94],roll:.28},{direction:[-.58,.68,-.45],width:74,type:1,aspect:.18,brightness:1.08,color:[.86,.71,.55],roll:-.64},{direction:[-.76,-.34,.55],width:68,type:0,aspect:.54,brightness:1,color:[.68,.74,.89],roll:1.16},{direction:[.31,-.81,.49],width:62,type:2,aspect:.74,brightness:.92,color:[.84,.71,.6],roll:.77},{direction:[.82,-.18,.54],width:56,type:3,aspect:.66,brightness:.88,color:[.66,.73,.87],roll:-1.05},{direction:[-.1,.88,.45],width:52,type:1,aspect:.2,brightness:.86,color:[.82,.7,.56],roll:.32},{direction:[.14,-.58,-.8],width:48,type:2,aspect:.78,brightness:.82,color:[.78,.7,.64],roll:-.92},{direction:[-.91,.09,-.4],width:56,type:0,aspect:.48,brightness:.86,color:[.66,.74,.92],roll:.56},{direction:[.09,.15,.98],width:60,type:0,aspect:.5,brightness:.9,color:[.73,.79,.95],roll:-.48},{direction:[-.24,-.94,-.23],width:50,type:1,aspect:.18,brightness:.8,color:[.88,.73,.57],roll:1.06},{direction:[.95,.21,-.22],width:46,type:2,aspect:.72,brightness:.78,color:[.8,.72,.66],roll:.18},{direction:[-.34,.22,.91],width:58,type:0,aspect:.46,brightness:.84,color:[.7,.77,.93],roll:-1.18}];function uf({count:e,radius:t}){let n=Hd(2976135881),r=new pa(1,1,1,1),i=new Float32Array(e*4);r.setAttribute(`aGalaxyData`,new hi(i,4));let a=new Ta({uniforms:{uVisibility:{value:0},uExposure:{value:1},uJourneyProgress:{value:0}},vertexShader:Qd,fragmentShader:$d,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1}),o=new Ci(r,a,e);o.name=`Layered visible distant galaxy field`,o.frustumCulled=!1,o.renderOrder=-25;for(let r=0;r<e;r+=1){let e=lf[r]??null;if(e)tf.fromArray(e.direction).normalize();else{let e=n()*Math.PI*2,t=n()*2-1,r=Math.sqrt(Math.max(0,1-t*t));tf.set(Math.cos(e)*r,t,Math.sin(e)*r)}nf.copy(tf).multiplyScalar(t+(n()-.5)*90),rf.setFromUnitVectors(ef,tf.clone().negate());let a=e?.roll??n()*Math.PI*2;af.setFromAxisAngle(tf,a),rf.multiply(af);let s=e?.type??Math.floor(n()*4),c=e?.width??10+n()**1.55*26,l=e?.aspect??(s===1?.14+n()*.14:.4+n()*.42);if(of.set(c,c*l,1),sf.compose(nf,rf,of),o.setMatrixAt(r,sf),e)cf.fromArray(e.color);else{let e=n();e<.48?cf.setRGB(.55,.62,.77):e<.82?cf.setRGB(.78,.65,.51):cf.setRGB(.67,.56,.72)}o.setColorAt(r,cf);let u=r*4;i[u]=e?.brightness??.24+n()**1.5*.38,i[u+1]=s,i[u+2]=n(),i[u+3]=l}return o.instanceMatrix.needsUpdate=!0,o.instanceColor&&(o.instanceColor.needsUpdate=!0),r.attributes.aGalaxyData.needsUpdate=!0,{object:o,update({visibility:e,exposure:t,journeyProgress:n=0}){a.uniforms.uVisibility.value=e,a.uniforms.uExposure.value=t,a.uniforms.uJourneyProgress.value=n},dispose(){r.dispose(),a.dispose()}}}var df=`
...
`;function wf(e,t){let n=Hd(2588811719),r=new Float32Array(e*3),i=new Float32Array(e*3),a=new Float32Array(e),o=new Float32Array(e),s=new Float32Array(e),c=new Float32Array(e),l=new Float32Array(e),u=new J,d=new J(1,.8,.62),f=0;for(;f<e;){let e=n()<.34,p=e?U.clamp(Ud(n)*.72,-Math.PI,Math.PI):n()*Math.PI*2-Math.PI,m=Math.sin(p*.72+.8)*.042+Math.sin(p*2.35-1.1)*.014,h=m+Ud(n)*(e?.07:.105);if(Math.abs(h-m)>.33)continue;let g=U.clamp(.46+Math.sin(p*2.7+.8)*.18+Math.sin(p*6.3-1.6)*.13+(e?.22:0),.12,1);if(n()>g)continue;let _=Math.cos(h),v=t-10+n()*20,y=f*3;r[y]=Math.cos(p)*_*v,r[y+1]=Math.sin(h)*v,r[y+2]=Math.sin(p)*_*v;let b=Math.exp(-((Math.abs(p)/.82)**1.7)),x=n()**7.2;_f(n,.18+x*.58+b*.12,u),u.lerp(d,b*.16),i[y]=u.r,i[y+1]=u.g,i[y+2]=u.b,a[f]=.96+x*3.05+b*n()*.42,o[f]=.32+x*.74+b*.14,s[f]=n()*Math.PI*2,c[f]=.02+n()*.045,l[f]=.055+x*.17,f+=1}let p=new wr;return p.setAttribute(`position`,new Y(r,3)),p.setAttribute(`aColor`,new Y(i,3)),p.setAttribute(`aSize`,new Y(a,1)),p.setAttribute(`aBrightness`,new Y(o,1)),p.setAttribute(`aPhase`,new Y(s,1)),p.setAttribute(`aSpeed`,new Y(c,1)),p.setAttribute(`aHalo`,new Y(l,1)),p}function Tf({count:e,radius:t,pixelRatio:n,rotation:r}){let i=new Sn;i.name=`Distant diagonal Milky Way`,i.rotation.set(...r);let a=new ha(t,112,72),o=new Ta({uniforms:{uVisibility:{value:0},uContrast:{value:1},uSolarSuppression:{value:1},uSunDirection:{value:new G(0,0,-1)}},vertexShader:Sf,fragmentShader:Cf,side:1,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,toneMapped:!1}),s=new X(a,o);s.name=`Restrained diffuse galactic band`,s.frustumCulled=!1,s.renderOrder=-30;let c=wf(e,t-22),l=vf({pixelRatio:n,maxPointSize:4.5}),u=new qi(c,l);return u.name=`Patchy resolved Milky Way stars`,u.frustumCulled=!1,u.renderOrder=-28,i.add(s,u),{object:i,update({time:e,visibility:t,contrast:n,exposure:r,solarSuppression:i,sunDirection:a,reducedMotion:s}){o.uniforms.uVisibility.value=t,o.uniforms.uContrast.value=n,o.uniforms.uSolarSuppression.value=i,o.uniforms.uSunDirection.value.copy(a),l.uniforms.uTime.value=e,l.uniforms.uVisibility.value=Math.min(1.48,t*1.16),l.uniforms.uExposure.value=r,l.uniforms.uSolarSuppression.value=i,l.uniforms.uSunDirection.value.copy(a),l.uniforms.uReducedMotion.value=+!!s},resize(e){l.uniforms.uPixelRatio.value=e},dispose(){a.dispose(),o.dispose(),c.dispose(),l.dispose()}}}function Ef({radius:e}){let t=new ha(e,64,40),n=new Ta({uniforms:{uVisibility:{value:0},uSunDirection:{value:new G(0,0,-1)}},vertexShader:Bd,fragmentShader:Vd,side:1,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,toneMapped:!0}),r=new X(t,n);return r.name=`Subtle zodiacal light`,r.frustumCulled=!1,r.renderOrder=-25,{object:r,update({visibility:e,sunDirection:t}){n.uniforms.uVisibility.value=e,n.uniforms.uSunDirection.value.copy(t)},dispose(){t.dispose(),n.dispose()}}}var Df=class{constructor({scene:e,camera:t,renderer:n,quality:r=null}){this.scene=e,this.camera=t,this.renderer=n,this.root=new Sn,this.root.name=`Layered solar-system space environment`,this.stateController=new Zd,this.layers=[],this.initialized=!1,this.paused=!1,this.sunPosition=new G,this.sunDirection=new G(0,0,-1),this.deepSkyAnchor=new G,this.hasSolarDirectionOverride=!1,this.updateContext={time:0,visibility:0,exposure:1,solarSuppression:1,sunDirection:this.sunDirection,sunPosition:this.sunPosition,reducedMotion:!1,contrast:1},this.motionQuery=window.matchMedia(`(prefers-reduced-motion: reduce)`),this.reducedMotion=this.motionQuery.matches,this.handleMotionPreference=e=>{this.reducedMotion=e.matches},this.motionQuery.addEventListener?.(`change`,this.handleMotionPreference),this.qualityName=r??Yd({reducedMotion:this.reducedMotion}),this.quality=qd[this.qualityName]??qd.medium}async init(){if(this.initialized)return this;let e=Jd.radii,t=Math.min(window.devicePixelRatio,this.quality.maxPixelRatio);return this.backgroundStars=bf({count:this.quality.backgroundStars,minimumRadius:e.backgroundStarShell-45,maximumRadius:e.backgroundStarShell+45,seed:1369960765,pixelRatio:t,name:`Deterministic distant stellar sphere`}),this.parallaxStars=bf({count:this.quality.parallaxStars,minimumRadius:e.parallaxMinimum,maximumRadius:e.parallaxMaximum,seed:2008825369,pixelRatio:t,name:`Subtle mid-distance parallax stars`,midDistance:!0}),this.milkyWay=Tf({count:this.quality.galacticStars,radius:e.milkyWayShell,pixelRatio:t,rotation:Jd.milkyWayRotation}),this.heroStars=xf({count:this.quality.heroStars,radius:e.heroStarShell,pixelRatio:t}),this.galaxies=uf({count:this.quality.galaxies,radius:e.galaxyShell}),this.dust=Gd({count:this.quality.dust,maximumRadius:e.dustMaximum,pixelRatio:t}),this.zodiacalLight=Ef({radius:e.parallaxMaximum+140}),this.layers.push(this.backgroundStars,this.parallaxStars,this.milkyWay,this.heroStars,this.galaxies,this.dust,this.zodiacalLight),this.root.add(...this.layers.map(e=>e.object)),this.scene.add(this.root),this.setQuality(this.qualityName),this.resize(window.innerWidth,window.innerHeight,window.devicePixelRatio),this.initialized=!0,this}setJourneyProgress(e){this.stateController.setJourneyProgress(e)}setSunPosition(e){this.sunPosition.copy(e),this.hasSolarDirectionOverride=!1}setSolarDirection(e){this.sunDirection.copy(e).normalize(),this.hasSolarDirectionOverride=!0}setPaused(e){this.paused=e}update(e,t){if(!this.initialized||this.paused)return this.stateController.state;let n=this.stateController.update(e);this.hasSolarDirectionOverride||(this.sunDirection.copy(this.sunPosition).sub(this.camera.position),this.sunDirection.lengthSq()<1e-8?this.sunDirection.set(0,0,-1):this.sunDirection.normalize()),this.renderer.toneMappingExposure=n.rendererExposure,this.deepSkyAnchor.copy(this.camera.position),this.backgroundStars.object.position.copy(this.deepSkyAnchor),this.milkyWay.object.position.copy(this.deepSkyAnchor),this.heroStars.object.position.copy(this.deepSkyAnchor),this.galaxies.object.position.copy(this.deepSkyAnchor);let r=this.updateContext;return r.time=t,r.exposure=n.backgroundContrast,r.solarSuppression=n.solarGlare,r.reducedMotion=this.reducedMotion,r.contrast=n.backgroundContrast,r.journeyProgress=n.journeyProgress,r.visibility=n.starVisibility,this.backgroundStars.update(r),r.visibility=n.starVisibility*(.22+n.journeyProgress*.26),this.parallaxStars.update(r),r.visibility=n.milkyWayVisibility,this.milkyWay.update(r),r.visibility=this.quality.heroStarsEnabled?n.heroStarVisibility:0,this.heroStars.update(r),r.visibility=this.quality.galaxiesEnabled?n.galaxyVisibility:0,this.galaxies.update(r),r.visibility=this.quality.dustEnabled?n.dustVisibility:0,this.dust.update(r),r.visibility=this.quality.zodiacalLightEnabled?n.zodiacalGlow:0,this.zodiacalLight.update(r),n}resize(e,t,n=window.devicePixelRatio){let r=Math.min(n,this.quality.maxPixelRatio);this.renderer.setPixelRatio(r),this.renderer.setSize(e,t),this.layers.forEach(e=>e.resize?.(r))}setQuality(e){let t=qd[e];t&&(this.qualityName=e,this.quality=t,this.heroStars&&(this.heroStars.object.visible=t.heroStarsEnabled),this.galaxies&&(this.galaxies.object.visible=t.galaxiesEnabled),this.dust&&(this.dust.object.visible=t.dustEnabled),this.zodiacalLight&&(this.zodiacalLight.object.visible=t.zodiacalLightEnabled))}dispose(){this.motionQuery.removeEventListener?.(`change`,this.handleMotionPreference),this.layers.forEach(e=>e.dispose?.()),this.root.removeFromParent(),this.layers.length=0,this.initialized=!1}};function Of(e){let t=[new G(.82,.16,.55).normalize(),new G(.76,.12,.64).normalize(),new G(.69,.22,.69).normalize(),new G(-.71,.33,.62).normalize(),new G(-.64,.26,.72).normalize(),new G(.22,-.58,.78).normalize(),new G(.29,-.52,.8).normalize(),new G(-.38,-.7,-.6).normalize()];return new Ta({uniforms:{uTime:{value:0},uMap:{value:e},uGlow:{value:1},uSpotDirections:{value:t},uSpotSizes:{value:[.0048,.0032,.0026,.004,.0027,.0038,.0024,.003]}},vertexShader:`
    ...
    `,transparent:!1,depthWrite:!0,depthTest:!0})}var kf=9.2;function Af({color:e,intensity:t,speed:n,power:r,waveScale:i=1}){return new Ta({uniforms:{uTime:{value:0},uColor:{value:new J(e)},uIntensity:{value:t},uSpeed:{value:n},uPower:{value:r},uWaveScale:{value:i}},vertexShader:`
      varying vec3 vNormalView;
      varying vec3 vViewDirection;
      varying vec3 vObjectDirection;
    ...
    `,transparent:!0,blending:2,depthWrite:!1,depthTest:!0,side:1})}function jf(e,t){let n=U.degToRad(90-e),r=U.degToRad(t);return new G(Math.sin(n)*Math.cos(r),Math.cos(n),Math.sin(n)*Math.sin(r))}function Mf(){let e=new Sn;e.name=`Solar spicules`;let t=new ra(.024,.34,4,1,!0),n=new ei({color:16777215,vertexColors:!0,transparent:!0,opacity:.18,blending:2,depthWrite:!1,depthTest:!0,side:2}),r=new G(0,1,0),i=new Ci(t,n,560);i.name=`Instanced solar spicules`;let a=new qt,o=new Tt,s=new G,c=new G,l=[new J(16728592),new J(16739608),new J(16751140),new J(16761677)];for(let e=0;e<560;e+=1){let t=1-e/559*2,n=Math.sqrt(1-t*t),u=e*Math.PI*(3-Math.sqrt(5)),d=new G(Math.cos(u)*n,t,Math.sin(u)*n),f=.1+e*37%41/41*.44;c.copy(d).multiplyScalar(kf+f*.44),o.setFromUnitVectors(r,d),s.set(.44+e%4*.08,f/.34,.44+e%3*.09),a.compose(c,o,s),i.setMatrixAt(e,a),i.setColorAt(e,l[e%l.length])}return i.instanceMatrix.needsUpdate=!0,i.instanceColor&&(i.instanceColor.needsUpdate=!0),e.add(i),e}function Nf(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`);t.save(),t.translate(128,128),t.scale(.72,1);let n=t.createRadialGradient(0,0,0,0,0,128);n.addColorStop(0,`rgba(255, 255, 245, 1)`),n.addColorStop(.08,`rgba(255, 248, 205, 0.98)`),n.addColorStop(.2,`rgba(255, 205, 95, 0.92)`),n.addColorStop(.4,`rgba(255, 111, 22, 0.72)`),n.addColorStop(.64,`rgba(210, 38, 4, 0.34)`),n.addColorStop(.82,`rgba(105, 9, 0, 0.10)`),n.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=n,t.fillRect(-128,-128,256,256),t.restore();let r=new Xi(e);return r.colorSpace=Re,r.minFilter=o,r.magFilter=o,r.generateMipmaps=!1,r}function Pf({latitude:e,longitude:t,height:n,bend:r,phase:i},a){let o=jf(e,t),s=Math.abs(o.y)>.9?new G(1,0,0):new G(0,1,0),c=new G().crossVectors(s,o).normalize(),l=new Sn;l.name=`Solar plasma jet`;let u=[16725256,16731915,16740372,16751909,16762954,16777121],d=Array.from({length:42},(e,t)=>{let n=new Wr(new Ar({map:a,color:u[t%u.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/42,n.userData.phase=i+t*1.17,l.add(n),n}),f=new Wr(new Ar({map:a,color:16777198,transparent:!0,opacity:.52,blending:2,depthWrite:!1,depthTest:!0}));return f.position.copy(o).multiplyScalar(kf*1.008),f.scale.set(.46,.46,1),l.add(f),l.userData={direction:o,tangent:c,height:n,bend:r,phase:i,particles:d,core:f},l}function Ff({angle:e,width:t,height:n,tilt:r,phase:i},a){let o=e-t*.5,s=e+t*.5,c=(e,t=kf*1.008)=>new G(Math.cos(e)*t,0,Math.sin(e)*t),l=c(o),u=c(s),d=(o+s)*.5,f=c(d-t*.18,kf+n),p=c(d+t*.18,kf+n);f.y=n*.2,p.y=n*.2;let m=new da(l,f,p,u),h=new Sn;h.name=`Coronal loop`,h.rotation.x=r;let g=[16728848,16740635,16753712,16777123];return h.userData={curve:m,particles:Array.from({length:34},(e,t)=>{let n=new Wr(new Ar({map:a,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/34,n.userData.phase=i+t*.93,h.add(n),n}),phase:i},h}function If({latitude:e,longitude:t,height:n,width:r,bend:i,phase:a},o){let s=new Sn;s.name=`Solar flare`;let c=jf(e,t),l=Math.abs(c.y)>.88?new G(1,0,0):new G(0,1,0),u=new G().crossVectors(l,c).normalize(),d=new G().crossVectors(c,u).normalize(),f=new Wr(new Ar({map:o,color:16777170,transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));f.position.copy(c).multiplyScalar(kf*1.008),f.scale.set(.35,.35,1),s.add(f);let p=c.clone().multiplyScalar(kf*1.01).addScaledVector(u,-r*.5),m=c.clone().multiplyScalar(kf*1.01).addScaledVector(u,r*.5),h=new da(p,c.clone().multiplyScalar(kf+n).addScaledVector(u,-r*.2).addScaledVector(d,i),c.clone().multiplyScalar(kf+n).addScaledVector(u,r*.2).addScaledVector(d,i),m),g=[16728592,16740120,16754221,16767068,16777156,16777215],_=Array.from({length:92},(e,t)=>{let n=new Wr(new Ar({map:o,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/92,n.userData.phase=a+t*.63,s.add(n),n}),v=Array.from({length:34},(e,t)=>{let n=new Wr(new Ar({map:o,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/34,n.userData.angle=t/34*Math.PI*2,n.userData.phase=a+t*1.13,s.add(n),n}),y=new X(new ma(.72,1,96),new ei({color:16757575,transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0,side:2}));return y.position.copy(c).multiplyScalar(kf*1.025),y.quaternion.setFromUnitVectors(new G(0,0,1),c),y.scale.setScalar(.1),s.add(y),s.userData={direction:c,tangent:u,bitangent:d,curve:h,height:n,width:r,bend:i,phase:a,core:f,arcParticles:_,ejectaParticles:v,shockWave:y},s}function Lf({world:e,hoverTargets:t,texture:n}){let r=new Sn;r.name=`Sun system`;let i=n??su(`sun`),a=new X(new ha(kf,192,128),Of(i));a.name=`Sun`,a.userData={name:`Sun`,detail:`G-type star | 99.86% of solar system mass`,focusScale:1.2,minFocusDistance:28,info:{type:`Star`,diameter:`1,392,700 km`,orbitalSpeed:`System reference body`,distanceFromEarth:`≈ 149.6 million km`,description:`A living ocean of plasma whose magnetic storms, radiant light, and immense gravity sustain every world in this planetary system.`}},r.add(a);let o=new X(new ha(kf*1.012,144,96),Af({color:16739352,intensity:.3,speed:.028,power:3.15,waveScale:18}));o.name=`Solar chromosphere`,r.add(o);let s=new X(new ha(kf*1.027,128,88),Af({color:16749599,intensity:.105,speed:.017,power:4.25,waveScale:11}));s.name=`Inner solar corona`;let c=new X(new ha(kf*1.046,112,80),Af({color:16762194,intensity:.032,speed:-.011,power:5.5,waveScale:8}));c.name=`Outer solar corona`,r.add(s,c);let l=cu(),u=Nf(),d=new Wr(new Ar({map:l,color:16738328,transparent:!0,opacity:.024,blending:2,depthWrite:!1,depthTest:!0}));d.name=`Solar glow`,d.scale.set(19.2,19.2,1),r.add(d);let f=Mf();r.add(f);let p=[{latitude:-24,longitude:18,height:1.75,bend:.42,phase:.4},{latitude:32,longitude:-48,height:1.15,bend:-.28,phase:1.9},{latitude:8,longitude:72,height:1.45,bend:.31,phase:3.2},{latitude:-46,longitude:-82,height:.95,bend:-.22,phase:4.5}].map(e=>Pf(e,u));r.add(...p);let m=[{angle:2.75,width:.25,height:1.65,tilt:.42,phase:1.2},{angle:5.35,width:.18,height:1.05,tilt:-.58,phase:4.1}].map(e=>Ff(e,u)),h=[{latitude:18,longitude:38,height:3.2,width:1.5,bend:.45,phase:.7},{latitude:-31,longitude:-62,height:2.4,width:1.1,bend:-.34,phase:3.4},{latitude:47,longitude:124,height:2.75,width:1.25,bend:.28,phase:6.2}].map(e=>If(e,u));r.add(...h),r.add(...m);let g=new fo(16768416,5600,1600,1.45);return g.name=`Solar point light`,r.add(g),e.add(r),t.push(a),{system:r,surface:a,chromosphere:o,innerCorona:s,outerCorona:c,glow:d,spicules:f,plasmaJets:p,coronalLoops:m,solarFlares:h,light:g}}function Rf(e,t,n=1){e.surface.rotation.y+=.00135*n,e.chromosphere.rotation.y-=42e-5*n,e.innerCorona.rotation.y+=25e-5*n,e.outerCorona.rotation.y-=14e-5*n,e.surface.material.uniforms?.uTime&&(e.surface.material.uniforms.uTime.value=t),e.chromosphere.material.uniforms?.uTime&&(e.chromosphere.material.uniforms.uTime.value=t),e.innerCorona.material.uniforms?.uTime&&(e.innerCorona.material.uniforms.uTime.value=t),e.outerCorona.material.uniforms?.uTime&&(e.outerCorona.material.uniforms.uTime.value=t);let r=1+Math.sin(t*.52)*.012;e.glow.scale.set(19.2*r,19.2*r,1),e.glow.material.opacity=.022+Math.sin(t*.67)*.0035,e.spicules.rotation.y+=34e-5*n,e.spicules.rotation.x=Math.sin(t*.11)*.005;let i=1+Math.sin(t*4.8)*.01;e.spicules.scale.setScalar(i);let a=e.spicules.children[0];a?.material&&(a.material.opacity=.15+Math.sin(t*5.2)*.024),e.plasmaJets.forEach(e=>{let{direction:n,tangent:r,height:i,bend:a,phase:o,particles:s,core:c}=e.userData;c.material.opacity=.25+Math.sin(t*2.8+o)*.09;let l=.39+Math.sin(t*3.4+o)*.055;c.scale.set(l,l,1),s.forEach(e=>{let s=(t*.072+e.userData.offset+o*.05)%1,c=kf*1.008+s*i,l=Math.sin(Math.PI*s)*a;e.position.copy(n).multiplyScalar(c).addScaledVector(r,l);let u=Math.sin(Math.PI*s)*(1-s*.62),d=Math.sin(t*5.4+e.userData.phase)*u*.075;e.position.addScaledVector(r,d);let f=.78+Math.sin(t*6.2+e.userData.phase)*.22,p=(.09+u*.29)*(.88+f*.18);e.scale.set(p*1.1,p*(1.35+s*.55),1),e.material.opacity=u*(.3+f*.22)})}),e.coronalLoops.forEach(e=>{let{curve:n,particles:r,phase:i}=e.userData;r.forEach(e=>{let r=(e.userData.offset+t*.018)%1,a=n.getPoint(r),o=Math.sin(t*3.6+e.userData.phase+i)*.028;a.y+=o,e.position.copy(a);let s=Math.sin(Math.PI*r),c=.72+Math.sin(t*5.1+e.userData.phase)*.28,l=(.047+s*.125)*(.82+c*.25);e.scale.set(l,l*1.2,1),e.material.opacity=s*(.1+c*.22)})}),e.solarFlares.forEach(e=>{let{direction:r,tangent:i,bitangent:a,curve:o,height:s,phase:c,core:l,arcParticles:u,ejectaParticles:d,shockWave:f}=e.userData,p=(t*.055+c*.13)%1,m=U.smoothstep(p,.05,.18)*(1-U.smoothstep(p,.68,.96)),h=.72+Math.sin(t*9+c)*.28,g=.24+m*.52*h;l.scale.set(g,g,1),l.material.opacity=m*(.36+h*.38),u.forEach(e=>{let n=(e.userData.offset+t*.028)%1,i=o.getPoint(n),s=Math.sin(t*5.8+e.userData.phase)*.045;i.addScaledVector(a,s).addScaledVector(r,s*.25),e.position.copy(i);let c=Math.sin(Math.PI*n),l=.68+Math.sin(t*8.5+e.userData.phase)*.32,u=(.065+c*.17)*(.82+l*.35)*m;e.scale.set(u*1.12,u*1.55,1),e.material.opacity=c*m*(.18+l*.5)}),d.forEach(e=>{let n=(p+e.userData.offset*.42)%1,o=Math.sin(Math.PI*n),c=kf*1.015+n*s*1.35,l=Math.sin(Math.PI*n)*(.18+n*.85),u=e.userData.angle;e.position.copy(r).multiplyScalar(c).addScaledVector(i,Math.cos(u)*l).addScaledVector(a,Math.sin(u)*l);let d=.66+Math.sin(t*7.2+e.userData.phase)*.34,f=(.035+o*.16)*d*m;e.scale.set(f,f*(1.25+n*.8),1),e.material.opacity=o*m*(.12+d*.34)});let _=U.clamp((p-.15)/.55,0,1),v=.2+_*3.8;f.scale.setScalar(v),f.material.opacity=Math.sin(Math.PI*_)*m*.16,f.rotation.z+=.0015*n})}(async()=>{let e=document.querySelector(`#universe`),t=document.querySelector(`#loader`),n=document.querySelector(`#progress-bar`),r=document.querySelector(`#body-card`),i=document.querySelector(`#body-connector`),a=document.querySelector(`#card-type`),o=document.querySelector(`#card-mode`),s=document.querySelector(`#card-name`),c=document.querySelector(`#card-diameter`),l=document.querySelector(`#card-speed`),u=document.querySelector(`#card-distance`),d=document.querySelector(`#card-description`),f=document.querySelector(`#card-hint`),p=document.querySelector(`#card-close`),m=new jn;m.background=new J(262),m.fog=new An(262,.00115);let h=new lo(56,innerWidth/innerHeight,.1,5e3),g=new tu({canvas:e,antialias:!0,alpha:!1,powerPreference:`high-performance`});g.setPixelRatio(Math.min(devicePixelRatio,2)),g.setSize(innerWidth,innerHeight),g.outputColorSpace=Re,g.toneMapping=4,g.toneMappingExposure=1.18;let _=new Lo,v=new Po,y=new W(-10,-10),b=new Sn,x=new Sn,S=[],C=[];m.add(b,x);let w=0,T=0,E=-.55,D=.22,ee=E,O=D,k=!1,te={x:0,y:0},A={x:0,y:0},j=0,M=null,ne=null,N=null,re=null,ie=-1/0,ae=!1,oe=0,se=0,ce=!document.hidden,le=new G,P=new G;m.add(new go(9281990,.16));let ue=new ho(9166079,.32);ue.position.set(-50,40,90),m.add(ue);let de=await uu(),fe=Lf({world:b,hoverTargets:C,texture:de.sun});_u.forEach(e=>{Id({config:e,textures:de,world:b,orbitRoot:x,planets:S,hoverTargets:C})});let pe=S.find(e=>e.name===`Earth`),me=new X(new ha(1.285,96,96),new Da({color:16777215,alphaMap:de.earthClouds??null,transparent:!0,opacity:de.earthClouds?.44:0,depthWrite:!1,roughness:1}));pe.add(me);let he=new X(new ha(1.305,96,96),new ei({color:6020351,transparent:!0,opacity:.18,side:1,blending:2}));if(pe.add(he),de.earthLights){let e=new X(new ha(1.265,96,96),new ei({color:16765818,map:de.earthLights,transparent:!0,opacity:.52,blending:2,depthWrite:!1}));pe.add(e)}let{moon:ge,moonPivot:_e}=gu({earth:pe,textures:de,hoverTargets:C}),ve=new Df({scene:m,camera:h,renderer:g});await ve.init();let ye=ud({world:b,hoverTargets:C}),be=S.find(e=>e.name===`Jupiter`);function xe(){let e=document.documentElement.scrollHeight-innerHeight;w=e>0?scrollY/e:0,n&&n.style&&(n.style.width=`${w*100}%`)}function Se(e){let t=e*e*(3-2*e);return U.lerp(4.8,980,t)}function Ce(){if(!M)return T;let e=String(M.userData?.name??M.name??``).toLowerCase(),t=String(M.userData?.info?.type??``).toLowerCase();return e.includes(`sun`)?Kd.sun:e.includes(`mercury`)?Kd.mercury:e.includes(`venus`)?Kd.venus:e.includes(`earth`)?Kd.earth:e.includes(`moon`)?Kd.moon:e.includes(`mars`)?Kd.mars:e.includes(`jupiter`)?Kd.jupiter:e.includes(`saturn`)?Kd.saturn:e.includes(`uranus`)?Kd.uranus:e.includes(`neptune`)?Kd.neptune:t.includes(`asteroid`)||e.includes(`asteroid`)||e.includes(`family`)?Kd.asteroidBelt:T}function we(e,t){return M?M.getWorldPosition(t):e<18?pe.getWorldPosition(t):t.set(0,0,0)}function Te(e){let t=!!e;if(r.classList.toggle(`is-visible`,t),r.setAttribute(`aria-hidden`,String(!t)),!e){ne=null,i.classList.remove(`is-visible`);return}if(ne!==e){let t=e.userData.info??{};a.textContent=t.type??`Celestial body`,s.textContent=e.userData.name??e.name,c.textContent=t.diameter??`Not available`,l.textContent=t.orbitalSpeed??`Not available`,u.textContent=t.distanceFromEarth??`Not available`,d.textContent=t.description??e.userData.detail??`No description available.`,ne=e}let n=M===e;o.textContent=n?`Slow motion · Focused`:`Hover preview`,f.textContent=n?`Slow motion active · Drag to inspect · Click empty space to exit`:`Click to focus · Focus activates slow motion · Then drag to inspect`}function Ee(e){if(!e||innerWidth<=760){i.classList.remove(`is-visible`);return}let t=e.getWorldPosition(new G).project(h),n=(t.x*.5+.5)*innerWidth,a=(-t.y*.5+.5)*innerHeight;if(!(t.z>-1&&t.z<1&&n>=0&&n<=innerWidth&&a>=0&&a<=innerHeight)){i.classList.remove(`is-visible`);return}let o=r.getBoundingClientRect(),s=o.left,c=U.clamp(a,o.top+26,o.bottom-26),l=s-n,u=c-a;i.style.left=`${n}px`,i.style.top=`${a}px`,i.style.width=`${Math.hypot(l,u)}px`,i.style.transform=`rotate(${Math.atan2(u,l)}rad)`,i.classList.add(`is-visible`)}function De(){let e=Ae();N&&e!==N&&(N=null);let t=M??e,n=t===N?null:t;document.body.classList.toggle(`is-hovering-body`,!!e),Te(n),Ee(n)}p.addEventListener(`click`,()=>{N=ne,je(null),Te(null)});function Oe(e){y.x=e.clientX/innerWidth*2-1,y.y=-(e.clientY/innerHeight)*2+1}function ke(e){let t=ed(e);if(t)return t;let n=e?.object;for(;n;){if(n.userData?.name)return n;n=n.parent}return null}function Ae(e=!1){let t=performance.now();if(!e&&t-ie<80)return re;ie=t,v.setFromCamera(y,h);let n=v.intersectObjects(C,!0).map(e=>ke(e)).filter(Boolean);return re=n.find(e=>e.userData?.info?.type===`Natural satellite`)??n[0]??null,re}function je(e){if(M&&td(M,!1),M=e&&M!==e?e:null,!M)return;td(M,!0);let t=e.userData.orbitRadius??e.getWorldPosition(new G).length(),n=U.clamp(t/230,.035,.72);window.scrollTo({top:n*(document.documentElement.scrollHeight-innerHeight),behavior:`smooth`})}addEventListener(`scroll`,xe,{passive:!0}),addEventListener(`pointermove`,e=>{Oe(e),k?(j=Math.max(j,Math.hypot(e.clientX-A.x,e.clientY-A.y)),E-=(e.clientX-te.x)*.006,D-=(e.clientY-te.y)*.004,D=U.clamp(D,-1.1,1.1)):ve.reducedMotion||(E+=y.x*5e-4,D+=y.y*25e-5),te={x:e.clientX,y:e.clientY}}),addEventListener(`pointerdown`,e=>{Oe(e),k=!0,j=0,A={x:e.clientX,y:e.clientY},te={x:e.clientX,y:e.clientY}}),addEventListener(`pointerup`,e=>{Oe(e),k=!1,!(e.target.closest?.(`.hud, .body-card`)||j>12)&&je(Ae(!0)||null)}),addEventListener(`pointercancel`,()=>{k=!1}),addEventListener(`keydown`,e=>{e.key===`Escape`&&je(null),e.key===`ArrowLeft`&&(E+=.18),e.key===`ArrowRight`&&(E-=.18),e.key===`ArrowUp`&&(D=U.clamp(D+.12,-1.1,1.1)),e.key===`ArrowDown`&&(D=U.clamp(D-.12,-1.1,1.1))}),addEventListener(`resize`,()=>{h.aspect=innerWidth/innerHeight,h.updateProjectionMatrix(),ve.resize(innerWidth,innerHeight,devicePixelRatio)}),addEventListener(`visibilitychange`,()=>{ce=!document.hidden,ve.setPaused(!ce),ce&&_.getDelta()}),addEventListener(`pagehide`,e=>{e.persisted||ve.dispose()});function Me(){let e=Math.min(_.getDelta(),.05);if(!ce){requestAnimationFrame(Me);return}se+=e;let t=M?.12:1;oe+=e*t,T=U.lerp(T,w,.065),ee=U.lerp(ee,E,.075),O=U.lerp(O,D,.075),S.forEach(e=>{let n=e.userData;n.angle+=n.orbitSpeed*.0024*t,e.position.set(Math.cos(n.angle)*n.orbitRadius,Math.sin(n.angle*.7)*Math.sin(n.tilt)*1.8,Math.sin(n.angle)*n.orbitRadius),e.rotation.y+=n.spinSpeed*t,Ld(e,oe,t)});let n=Se(T);we(n,P),ae||=(le.copy(P),!0);let r=M?.userData?.focusEase??(M?.055:.075);le.lerp(P,r);let i=M?.userData?.focusScale??1,a=M?.userData?.minFocusDistance??4.5,o=M?.userData?.focusDistance,s=M?o??Math.max(a,Math.min(n,30/i)):n,c=Math.cos(O)*Math.sin(ee)*s,l=Math.sin(O)*s*.64,u=Math.cos(O)*Math.cos(ee)*s;h.position.set(le.x+c,le.y+l,le.z+u),h.lookAt(le);let d=M?M.userData.focusFov??30:U.lerp(42,72,T);h.fov=U.lerp(h.fov,d,M?.08:.04),h.updateProjectionMatrix(),me.rotation.y+=.0032,he.rotation.y-=.0014,_e.rotation.y+=.011*t,ge.rotation.y=Math.sin(oe*.35)*.04,Rf(fe,oe,t),dd(ye,t,be),ve.setJourneyProgress(Ce()),ve.update(e,se),x.children.forEach(e=>{e.material.opacity=U.clamp((T-.035)/.18,.04,.22)}),h.updateMatrixWorld(),De(),g.render(m,h),requestAnimationFrame(Me)}xe(),Me(),setTimeout(()=>{t.classList.add(`is-hidden`)},1350)})();