...
`;function Hd(e){let t=e>>>0;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Ud(e){let t=Math.max(1e-7,e());return Math.sqrt(-2*Math.log(t))*Math.cos(Math.PI*2*e())}function Wd(e,t,n){let r=Math.min(1,Math.max(0,(e-t)/(n-t)));return r*r*r*(r*(r*6-15)+10)}function Gd({count:e,maximumRadius:t,pixelRatio:n}){let r=Hd(3495403806),i=new Float32Array(e*3),a=new Float32Array(e),o=new Float32Array(e);for(let n=0;n<e;n+=1){let e=n*3,s=18+Math.sqrt(r())*(t-18),c=r()*Math.PI*2;if(r()<.62)i[e]=Math.cos(c)*s,i[e+1]=U.clamp(Ud(r)*16,-54,54),i[e+2]=Math.sin(c)*s;else{let t=r()*2-1,n=Math.sqrt(Math.max(0,1-t*t));i[e]=Math.cos(c)*n*s,i[e+1]=t*s*.72,i[e+2]=Math.sin(c)*n*s}a[n]=.42+r()**4.2*.9,o[n]=r()*Math.PI*2}let s=new wr;s.setAttribute(`position`,new Y(i,3)),s.setAttribute(`aSize`,new Y(a,1)),s.setAttribute(`aPhase`,new Y(o,1));let c=new Ta({uniforms:{uTime:{value:0},uPixelRatio:{value:n},uVisibility:{value:0},uReducedMotion:{value:0},uSunPosition:{value:new G}},vertexShader:Rd,fragmentShader:zd,transparent:!0,depthWrite:!1,depthTest:!0,blending:1,toneMapped:!0}),l=new qi(s,c);return l.name=`Rare angle-dependent interplanetary dust glints`,l.frustumCulled=!1,l.renderOrder=-12,{object:l,update({time:e,visibility:t,sunPosition:n,reducedMotion:r}){c.uniforms.uTime.value=e,c.uniforms.uVisibility.value=t,c.uniforms.uSunPosition.value.copy(n),c.uniforms.uReducedMotion.value=+!!r,r||(l.rotation.y=e*18e-5)},resize(e){c.uniforms.uPixelRatio.value=e},dispose(){s.dispose(),c.dispose()}}}var Kd=Object.freeze({sun:0,mercury:.08,venus:.16,earth:.25,moon:.29,mars:.36,asteroidBelt:.46,jupiter:.56,saturn:.67,uranus:.77,neptune:.86,kuiperBelt:.94,interstellar:1}),qd=Object.freeze({high:{maxPixelRatio:2,backgroundStars:3e4,galacticStars:26e3,parallaxStars:1300,heroStars:72,galaxies:96,dust:720,heroStarsEnabled:!0,galaxiesEnabled:!0,zodiacalLightEnabled:!0,dustEnabled:!0},medium:{maxPixelRatio:1.5,backgroundStars:21e3,galacticStars:18500,parallaxStars:900,heroStars:52,galaxies:72,dust:420,heroStarsEnabled:!0,galaxiesEnabled:!0,zodiacalLightEnabled:!0,dustEnabled:!0},low:{maxPixelRatio:1.25,backgroundStars:12e3,galacticStars:1e4,parallaxStars:480,heroStars:28,galaxies:40,dust:180,heroStarsEnabled:!0,galaxiesEnabled:!0,zodiacalLightEnabled:!1,dustEnabled:!1}}),Jd=Object.freeze({radii:{dustMaximum:225,parallaxMinimum:680,parallaxMaximum:1120,galaxyShell:1720,heroStarShell:1780,backgroundStarShell:1860,milkyWayShell:1960},exposure:{innerSolar:1,middleSolar:1.04,outerSolar:1.08,interstellar:1.12},damping:{environment:3.5},milkyWayRotation:[.25,-.1,-.32]});function Yd({reducedMotion:e=!1}={}){let t=Math.min(window.innerWidth,window.innerHeight),n=navigator.hardwareConcurrency??8,r=navigator.deviceMemory??8,i=window.devicePixelRatio>2.2;return t<560||n<=4||r<=3?`low`:e||t<850||n<=6||r<=6||i?`medium`:`high`}var Xd=[`journeyProgress`,`solarInfluence`,`solarGlare`,`rendererExposure`,`directLightIntensity`,`sunApparentScale`,`starVisibility`,`heroStarVisibility`,`milkyWayVisibility`,`galaxyVisibility`,`dustVisibility`,`zodiacalGlow`,`debrisVisibility`,`backgroundContrast`,`bloomStrength`,`lensFlareStrength`],Zd=class{constructor(){this.journeyProgress=0,this.state=this.#e(0,{}),this.targets={...this.state}}setJourneyProgress(e){this.journeyProgress=Math.min(1,Math.max(0,e))}update(e){let t=this.#e(this.journeyProgress,this.targets),n=1-Math.exp(-Jd.damping.environment*e);return Xd.forEach(e=>{this.state[e]+=(t[e]-this.state[e])*n}),this.state}#e(e,t){let n=Wd(e,.24,.7),r=Wd(e,.6,.94),i=Wd(e,.82,1),a=1-Wd(e,.1,.97),o=Jd.exposure.innerSolar+n*(Jd.exposure.outerSolar-Jd.exposure.innerSolar)+i*(Jd.exposure.interstellar-Jd.exposure.outerSolar);return t.journeyProgress=e,t.solarInfluence=a,t.solarGlare=a*(1-r*.78),t.rendererExposure=o,t.directLightIntensity=.72+a*.28,t.sunApparentScale=.42+a*.58,t.starVisibility=.82+n*.12+r*.22+i*.12,t.heroStarVisibility=.26+n*.1+r*.3+i*.26,t.milkyWayVisibility=.16+n*.12+r*.26+i*.18,t.galaxyVisibility=.18+n*.14+r*.34+i*.3,t.dustVisibility=.012+a*.03*(1-i),t.zodiacalGlow=.075*a*(1-r*.92),t.debrisVisibility=.16+n*.34,t.backgroundContrast=1.06+r*.15+i*.07,t.bloomStrength=.36+a*.18,t.lensFlareStrength=a*.5,t}},Qd=`
...
`,ef=new G(0,0,1),tf=new G,nf=new G,rf=new Tt,af=new Tt,of=new G,sf=new qt,cf=new J,lf=[{direction:[.66,.38,-.65],width:72,type:0,aspect:.44,brightness:1.16,color:[.72,.78,.94],roll:.28},{direction:[-.58,.68,-.45],width:64,type:1,aspect:.18,brightness:1,color:[.86,.71,.55],roll:-.64},{direction:[-.76,-.34,.55],width:58,type:0,aspect:.54,brightness:.94,color:[.68,.74,.89],roll:1.16},{direction:[.31,-.81,.49],width:52,type:2,aspect:.74,brightness:.86,color:[.84,.71,.6],roll:.77},{direction:[.82,-.18,.54],width:48,type:3,aspect:.66,brightness:.82,color:[.66,.73,.87],roll:-1.05},{direction:[-.1,.88,.45],width:44,type:1,aspect:.2,brightness:.8,color:[.82,.7,.56],roll:.32},{direction:[.14,-.58,-.8],width:40,type:2,aspect:.78,brightness:.74,color:[.78,.7,.64],roll:-.92},{direction:[-.91,.09,-.4],width:46,type:0,aspect:.48,brightness:.78,color:[.66,.74,.92],roll:.56}];function uf({count:e,radius:t}){let n=Hd(2976135881),r=new pa(1,1,1,1),i=new Float32Array(e*4);r.setAttribute(`aGalaxyData`,new hi(i,4));let a=new Ta({uniforms:{uVisibility:{value:0},uExposure:{value:1},uJourneyProgress:{value:0}},vertexShader:Qd,fragmentShader:$d,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1}),o=new Ci(r,a,e);o.name=`Layered visible distant galaxy field`,o.frustumCulled=!1,o.renderOrder=-25;for(let r=0;r<e;r+=1){let e=lf[r]??null;if(e)tf.fromArray(e.direction).normalize();else{let e=n()*Math.PI*2,t=n()*2-1,r=Math.sqrt(Math.max(0,1-t*t));tf.set(Math.cos(e)*r,t,Math.sin(e)*r)}nf.copy(tf).multiplyScalar(t+(n()-.5)*90),rf.setFromUnitVectors(ef,tf.clone().negate());let a=e?.roll??n()*Math.PI*2;af.setFromAxisAngle(tf,a),rf.multiply(af);let s=e?.type??Math.floor(n()*4),c=e?.width??8+n()**1.6*22,l=e?.aspect??(s===1?.14+n()*.14:.4+n()*.42);if(of.set(c,c*l,1),sf.compose(nf,rf,of),o.setMatrixAt(r,sf),e)cf.fromArray(e.color);else{let e=n();e<.48?cf.setRGB(.55,.62,.77):e<.82?cf.setRGB(.78,.65,.51):cf.setRGB(.67,.56,.72)}o.setColorAt(r,cf);let u=r*4;i[u]=e?.brightness??.2+n()**1.6*.34,i[u+1]=s,i[u+2]=n(),i[u+3]=l}return o.instanceMatrix.needsUpdate=!0,o.instanceColor&&(o.instanceColor.needsUpdate=!0),r.attributes.aGalaxyData.needsUpdate=!0,{object:o,update({visibility:e,exposure:t,journeyProgress:n=0}){a.uniforms.uVisibility.value=e,a.uniforms.uExposure.value=t,a.uniforms.uJourneyProgress.value=n},dispose(){r.dispose(),a.dispose()}}}var df=`
