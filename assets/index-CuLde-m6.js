...
void main() {
    ...
    `,vertexColors:!0,transparent:!0,depthWrite:!1,blending:1}));return s.name=`Virtual million-object pebble population`,s.frustumCulled=!1,s}function Uu({name:e,composition:t,centreRadius:n,centreAngle:r,inclination:i,count:a,seedOffset:o,container:s,rocks:c,materials:l,geometryPool:u}){for(let d=0;d<a;d+=1){let a=o+d,f={semiMajor:n+($(a+4)-.5)*.55,eccentricity:.025+$(a+5)*.055,inclination:i+($(a+6)-.5)*.045,node:$(a+7)*Math.PI*2,angle:r+($(a+8)-.5)*.62,speed:25e-5+$(a+9)*22e-5},p=.055+$(a+10)**2.8*.18,m=zu({index:a,composition:t,size:p,orbit:f,materials:l,geometryPool:u,name:`${e} family member ${String(d+1).padStart(2,`0`)}`,diameter:`${Math.round(4+p*105)} km`,description:`A fragment produced by the ancient collision that formed the ${e} family.`,family:`${e} family`,surfaceBoulders:p>.14?3:0});s.add(m),c.push(m)}}function Wu({label:e,offset:t,seedOffset:n,count:r,container:i,rocks:a,materials:o,geometryPool:s}){for(let c=0;c<r;c+=1){let r=n+c,l={semiMajor:bu+($(r+2)-.5)*4.2,eccentricity:.01+$(r+3)*.08,inclination:($(r+4)-.5)*.22,node:$(r+5)*Math.PI*2,angle:t+($(r+6)-.5)*.56,speed:0,trojanOffset:t,trojanSpread:($(r+6)-.5)*.56},u=.045+$(r+8)**3*.14,d=zu({index:r,composition:`C`,size:u,orbit:l,materials:o,geometryPool:s,name:`${e} Trojan ${String(c+1).padStart(2,`0`)}`,diameter:`${Math.round(3+u*90)} km`,description:`A dark primitive body librating around Jupiter's ${e} Trojan region, roughly 60° from the planet.`,family:`${e} Trojan swarm`,population:`Trojan cloud`,archetype:c%3==0?`top`:`rubble`,surfaceBoulders:u>.12?4:0});i.add(d),a.push(d)}}function Gu(){let e={};return Object.entries(Cu).forEach(([t,n])=>{e[t]={},new Set([...n.archetypes,`irregular`,`rounded`,`basin`]).forEach(n=>{e[t][n]=Array.from({length:4},(e,r)=>Fu({seed:t.charCodeAt(0)*100+n.length*17+r*29,composition:t,archetype:n,detail:4,roundness:n===`rounded`?.62:.08,majorBasin:!1}))})}),e}function Ku({world:e,hoverTargets:t=[]}){let n=new xn;n.name=`Asteroid populations`;let r=new xn;r.name=`Main asteroid belt`;let i=new xn;i.name=`Jupiter Trojan clouds`,n.add(r,i);let a=Nu(),o=Gu(),s=[];wu.forEach((e,t)=>{let n={semiMajor:e.radius,eccentricity:e.eccentricity,inclination:e.inclination,node:$(t+301)*Math.PI*2,angle:e.angle,speed:e.orbitalSpeed},i=Fu({seed:900+t,composition:e.composition,archetype:e.archetype,detail:5,roundness:e.roundness,majorBasin:e.name===`Vesta`});o[e.composition][e.archetype]=[i];let c=zu({index:700+t,composition:e.composition,size:e.size,orbit:n,materials:a,geometryPool:o,name:e.name,diameter:e.diameter,description:e.description,family:`${e.name} major body`,archetype:e.archetype,surfaceBoulders:e.name===`Ceres`?6:e.name===`Vesta`?9:7});r.add(c),s.push(c)});let c=0,l=0;for(;c<250&&l<5e3;){let e=1e3+l;l+=1;let t=vu+$(e+1)*(yu-vu);if(Au(t))continue;let n=ju(t,e+2),i={semiMajor:t,eccentricity:.015+$(e+3)*.18,inclination:($(e+4)-.5)*.3,node:$(e+5)*Math.PI*2,angle:$(e+6)*Math.PI*2,speed:2e-4+$(e+7)*42e-5},u=.035+$(e+8)**4.6*.34,d=Cu[n].archetypes,f=d[Math.floor($(e+11)*d.length)],p=zu({index:e,composition:n,size:u,orbit:i,materials:a,geometryPool:o,name:`${Cu[n].label.split(` `)[0]} asteroid ${String(c+1).padStart(3,`0`)}`,diameter:`${Math.max(2,Math.round(u*120))} km`,description:Cu[n].description,family:`Background population`,archetype:f,surfaceBoulders:u>.16?4+Math.floor($(e+12)*4):0});r.add(p),s.push(p),c+=1}Uu({name:`Flora`,composition:`S`,centreRadius:44.9,centreAngle:1.1,inclination:.08,count:24,seedOffset:2200,container:r,rocks:s,materials:a,geometryPool:o}),Uu({name:`Eos`,composition:`C`,centreRadius:50.2,centreAngle:3.7,inclination:.18,count:22,seedOffset:2400,container:r,rocks:s,materials:a,geometryPool:o}),Uu({name:`Koronis`,composition:`S`,centreRadius:49.5,centreAngle:5.15,inclination:.05,count:20,seedOffset:2600,container:r,rocks:s,materials:a,geometryPool:o}),Wu({label:`L4 leading`,offset:Math.PI/3,seedOffset:3e3,count:42,container:i,rocks:s,materials:a,geometryPool:o}),Wu({label:`L5 trailing`,offset:-Math.PI/3,seedOffset:3400,count:42,container:i,rocks:s,materials:a,geometryPool:o});let{field:u,meshes:d}=Vu(a),f=Hu();return r.add(u,f),e.add(n),t.push(...s),{system:n,mainBelt:r,trojans:i,rocks:s,instancedBoulderField:u,instancedBoulders:d,distantDebris:f}}function qu(e,t=1,n=null){if(!e)return;let r=n?.userData?.angle??0;e.rocks.forEach(e=>{let n=e.userData.orbit;n&&(n.trojanOffset===void 0?n.angle+=n.speed*t:n.angle=r+n.trojanOffset+n.trojanSpread,Iu(e.position,n,n.angle),e.rotation.x+=e.userData.spin.x*t,e.rotation.y+=e.userData.spin.y*t,e.rotation.z+=e.userData.spin.z*t)}),e.instancedBoulders?.forEach(e=>{e.rotation.y+=e.userData.rotationSpeed*t}),e.distantDebris.rotation.y+=45e-6*t}function Ju(e,t=.86){return new Ta({uniforms:{uTime:{value:0},uSize:{value:e},uOpacity:{value:t}},vertexShader:`
    ...
    `,transparent:!1,depthWrite:!0,depthTest:!0})}function Xu(e,{count:t,radius:n,position:r,colors:i,size:a,spiral:o=!1,opacity:s=.86}){let c=new wr,l=new Float32Array(t*3),u=new Float32Array(t*3),d=new Float32Array(t),f=new Float32Array(t),p=new Float32Array(t),m=i.map(e=>new Y(e));for(let e=0;e<t;e+=1){let t=e*3;if(o){let r=e%4,i=Math.random()**.58*n,a=i*.11+r*Math.PI*.5+(Math.random()-.5)*.55;l[t]=Math.cos(a)*i,l[t+1]=(Math.random()-.5)*(1.8+i*.025),l[t+2]=Math.sin(a)*i}else{let e=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1),i=Math.random()**.72*n;l[t]=Math.sin(r)*Math.cos(e)*i,l[t+1]=Math.cos(r)*i*.7,l[t+2]=Math.sin(r)*Math.sin(e)*i}let r=m[Math.floor(Math.random()*m.length)];u[t]=r.r,u[t+1]=r.g,u[t+2]=r.b,d[e]=Math.random()*Math.PI*2,f[e]=.8+Math.random()*3.8,p[e]=.45+Math.random()*1.35}c.setAttribute(`position`,new lr(l,3)),c.setAttribute(`aColor`,new lr(u,3)),c.setAttribute(`aPhase`,new lr(d,1)),c.setAttribute(`aSpeed`,new lr(f,1)),c.setAttribute(`aScale`,new lr(p,1));let h=new qi(c,Ju(a,s));return h.position.copy(r),e.add(h),h}function Zu(e,t,n=16777215,r=.18,i=0){let a=Array.from({length:241},(e,n)=>{let r=n/240*Math.PI*2;return new K(Math.cos(r)*t,0,Math.sin(r)*t)}),o=new Bi(new wr().setFromPoints(a),new Mi({color:n,transparent:!0,opacity:r}));return o.rotation.x=i,e.add(o),o}var Qu={Jupiter:{cream:new Y(15259058),lightBand:new Y(16773847),darkBand:new Y(4990751),accent:new Y(12084790),polar:new Y(2378599),polarLight:new Y(12114405),bandFrequency:24,fineFrequency:74,turbulence:.145,textureStrength:.35,atmosphereColor:9423840,atmosphereOpacity:.15},Saturn:{cream:new Y(15259309),lightBand:new Y(16772551),darkBand:new Y(9333315),accent:new Y(12094805),polar:new Y(11977655),polarLight:new Y(15199971),bandFrequency:31,fineFrequency:92,turbulence:.045,textureStrength:.65,atmosphereColor:15849895,atmosphereOpacity:.085},Uranus:{cream:new Y(9428452),lightBand:new Y(13170420),darkBand:new Y(5609892),accent:new Y(11070960),polar:new Y(14221311),polarLight:new Y(15794175),bandFrequency:18,fineFrequency:58,turbulence:.026,textureStrength:.48,atmosphereColor:11075583,atmosphereOpacity:.12},Neptune:{cream:new Y(1529800),lightBand:new Y(7518207),darkBand:new Y(400216),accent:new Y(2275539),polar:new Y(2977752),polarLight:new Y(11196927),bandFrequency:24,fineFrequency:88,turbulence:.105,textureStrength:.34,atmosphereColor:6072831,atmosphereOpacity:.18}};function $u(e){return new Da({map:e,color:16777215,roughness:1,metalness:.01,envMapIntensity:.06})}function ed(e){return new Da({map:e,color:16777215,roughness:.98,metalness:0,envMapIntensity:.07})}function td(e){return new Da({map:e,color:9196071,roughness:1,metalness:0,bumpMap:e,bumpScale:.008,envMapIntensity:.02})}function nd(e,t){let n=t[e.texture]??su(e.texture);return e.name===`Mercury`?$u(n):e.name===`Mars`?ed(n):e.name===`Venus`?td(n):new Da({map:n,roughness:.96,metalness:0,bumpMap:e.bump?n:null,bumpScale:e.bump??0,displacementMap:e.bump?n:null,displacementScale:(e.bump??0)*.35,displacementBias:-((e.bump??0)*.18),normalMap:e.normalTexture?t[e.normalTexture]:null,normalScale:new G(e.normalScale??.55,e.normalScale??.55),envMapIntensity:.1})}function rd(e,t,n){let r=Math.sin(e*127.1+t*311.7+n*74.7)*43758.5453123;return r-Math.floor(r)}function id(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=Math.floor(n),o=e-r,s=t-i,c=n-a,l=o*o*(3-2*o),u=s*s*(3-2*s),d=c*c*(3-2*c),f=(e,t,n)=>e+(t-e)*n,p=f(rd(r,i,a),rd(r+1,i,a),l),m=f(rd(r,i+1,a),rd(r+1,i+1,a),l),h=f(rd(r,i,a+1),rd(r+1,i,a+1),l),g=f(rd(r,i+1,a+1),rd(r+1,i+1,a+1),l);return f(f(p,m,u),f(h,g,u),d)}function ad(e,t,n=5){let r=0,i=.5,a=0,o=e.x*t,s=e.y*t,c=e.z*t;for(let e=0;e<n;e+=1)r+=id(o,s,c)*i,a+=i,o=o*2.03+7.2,s=s*2.03+11.8,c=c*2.03+5.4,i*=.5;return r/a}function od(e,t,n,r,i){let a=t>>>0,o=()=>(a=a*1664525+1013904223>>>0,a/4294967296);return Array.from({length:e},()=>{let e=o()*2-1,t=o()*Math.PI*2,a=Math.sqrt(1-e*e),s=n+o()**2.1*(r-n);return{direction:new K(Math.cos(t)*a,e,Math.sin(t)*a),angularRadius:s,depth:s*i*(.72+o()*.5),rim:s*i*(.2+o()*.22)}})}var sd=[...od(76,481516,.022,.15,.055),{direction:new K(-.78,.22,.58).normalize(),angularRadius:.29,depth:.014,rim:.0045}],cd=od(34,230319,.018,.095,.042);function ld(e,t,n){let r=Math.acos(W.clamp(e.dot(t.direction),-1,1))/t.angularRadius;if(r>1.28)return 0;let i=r<1?-((1-r*r)**2)*t.depth*n:0,a=(r-1)/.16;return i+Math.exp(-(a*a))*t.rim*n}function ud(e,t){return Math.atan2(Math.sin(e-t),Math.cos(e-t))}function dd(e,t){if(![`Mercury`,`Mars`].includes(t.name))return e;let n=e.attributes.position,r=new K,i=t.radius,a=t.name===`Mercury`?sd:cd;for(let e=0;e<n.count;e+=1){r.fromBufferAttribute(n,e).normalize();let o=ad(r,t.name===`Mercury`?5.8:4.3,5)-.5,s=ad(r,t.name===`Mercury`?22:15,4)-.5,c=i*(o*(t.name===`Mercury`?.016:.011)+s*(t.name===`Mercury`?.006:.004));if(a.forEach(e=>{c+=ld(r,e,i)}),t.name===`Mars`){let e=Math.asin(W.clamp(r.y,-1,1)),t=Math.atan2(r.z,r.x);[-.9,-.48,-.06].forEach((n,r)=>{let a=ud(t,n),o=e-(-.2+r*.012),s=Math.exp(-(a*a)/.12-o*o/.0014),l=.72+.28*Math.sin(t*19+e*31);c-=i*.009*s*l});let n=new K(-.61,.31,-.73).normalize(),a=Math.acos(W.clamp(r.dot(n),-1,1)),o=Math.exp(-((a/.19)**2)),s=Math.exp(-((a/.035)**2));c+=i*.012*o,c-=i*.0045*s}r.multiplyScalar(i+c),n.setXYZ(e,r.x,r.y,r.z)}return n.needsUpdate=!0,e.computeVertexNormals(),e.computeBoundingSphere(),e.computeBoundingBox(),e.userData.terrainKind=t.name,e}function fd(e,t){let n=Qu[e.name];return new Ta({uniforms:{uTime:{value:0},uMap:{value:t},uCream:{value:n.cream},uLightBand:{value:n.lightBand},uDarkBand:{value:n.darkBand},uAccent:{value:n.accent},uPolar:{value:n.polar},uPolarLight:{value:n.polarLight},uBandFrequency:{value:n.bandFrequency},uFineFrequency:{value:n.fineFrequency},uTurbulence:{value:n.turbulence},uTextureStrength:{value:n.textureStrength},uPlanetKind:{value:e.name===`Jupiter`?1:e.name===`Saturn`?2:e.name===`Uranus`?3:4}},vertexShader:`
      varying vec2 vUv;
      varying vec3 vObjectDirection;
    ...
    `,depthWrite:!0,depthTest:!0})}function pd(e,t){return new Ta({uniforms:{uColor:{value:new Y(e)},uOpacity:{value:t}},vertexShader:`
      varying vec3 vNormalView;
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1})}function md(e,t){let n,r,i;if(t.name===`Venus`)n=16766866,r=.32,i=1.045;else if(Qu[t.name]){let e=Qu[t.name];n=e.atmosphereColor,r=e.atmosphereOpacity,i=t.name===`Jupiter`?1.014:t.name===`Neptune`?1.024:1.018}else if(t.name===`Mars`)n=14912851,r=.082,i=1.018;else if(t.name===`Mercury`)return null;else return null;let a=new X(new ha(t.radius*i,144,120),pd(n,r));return a.name=`${t.name} atmosphere`,e.add(a),a}function hd(e,t,n){return new Ta({uniforms:{uTime:{value:0},uBase:{value:new Y(e)},uOpacity:{value:t},uCloudMap:{value:n}},vertexShader:`
      varying vec2 vUv;
      varying vec3 vObjectDirection;
      varying vec3 vNormalView;
      varying vec3 vViewDirection;
    ...
    `,transparent:!0,depthWrite:!1})}function gd(e,t,n){let r=new xn;r.name=`Venus cloud deck`;let i=new X(new ha(t.radius*1.012,192,152),new Da({map:n.venusAtmosphere,color:16777215,roughness:1,metalness:0,envMapIntensity:.03}));i.name=`Venus lower cloud layer`,r.add(i);let a=new X(new ha(t.radius*1.018,160,128),hd(15906413,.22,n.venusAtmosphere));a.name=`Venus middle cloud layer`,a.rotation.y=.72,a.rotation.z=.025,r.add(a);let o=new X(new ha(t.radius*1.028,160,128),hd(16768688,.12,n.venusAtmosphere));o.name=`Venus upper haze layer`,o.rotation.y=1.2,r.add(o);let s=new X(new ha(t.radius*1.052,128,96),pd(16763512,.22));return s.name=`Venus soft glow`,r.add(s),e.add(r),r}function _d({innerRadius:e,outerRadius:t,color:n,opacity:r,roughness:i=.9,texture:a=null}){let o=new Da({map:a,color:n,side:2,transparent:!0,opacity:r,roughness:i,metalness:0,alphaTest:.008,depthWrite:!1}),s=new X(new ma(e,t,320),o);return s.rotation.x=Math.PI*.5,s}function vd(e,t,n){let r=new xn;if(r.name=`${t.name} ring system`,t.name===`Saturn`){let e=t.radius,i=n.saturnRing??null;[{innerRadius:e*1.16,outerRadius:e*1.3,color:9271651,opacity:.24},{innerRadius:e*1.31,outerRadius:e*1.49,color:12363651,opacity:.47},{innerRadius:e*1.51,outerRadius:e*1.73,color:15785914,opacity:.91,texture:i},{innerRadius:e*1.79,outerRadius:e*1.96,color:14073750,opacity:.76,texture:i},{innerRadius:e*2.04,outerRadius:e*2.065,color:15918796,opacity:.56}].forEach((e,t)=>{let n=_d(e);n.name=`Saturn ring band ${t+1}`,r.add(n)});let a=_d({innerRadius:e*2.09,outerRadius:e*2.105,color:16775135,opacity:.28});r.add(a)}if(t.name===`Jupiter`){let e=t.radius;[{innerRadius:e*1.2,outerRadius:e*1.28,color:9139819,opacity:.055},{innerRadius:e*1.31,outerRadius:e*1.47,color:10456451,opacity:.04},{innerRadius:e*1.49,outerRadius:e*1.66,color:11772826,opacity:.025}].forEach((e,t)=>{let n=_d(e);n.name=`Jupiter dust ring ${t+1}`,r.add(n)})}if(t.name===`Uranus`){let e=t.radius;[[1.42,.01,7246490,.42],[1.51,.012,9551557,.48],[1.6,.01,6324103,.38],[1.71,.015,12575719,.56],[1.83,.011,7444897,.41],[1.96,.014,13823728,.52],[2.11,.013,9354691,.45]].forEach(([t,n,i,a],o)=>{let s=new Da({color:i,emissive:new Y(i).multiplyScalar(.16),emissiveIntensity:.42,transparent:!0,opacity:a,roughness:.72,metalness:0,side:2,depthWrite:!1}),c=new X(new ga(e*t,Math.max(.012,e*n),8,360),s);c.name=`Uranus three-dimensional ring ${o+1}`,c.rotation.x=Math.PI*.5,r.add(c)});let n=_d({innerRadius:e*1.38,outerRadius:e*2.18,color:8894141,opacity:.035,roughness:1});n.name=`Uranus faint ring dust sheet`,r.add(n)}if(t.name===`Neptune`){let e=t.radius;[{innerRadius:e*1.4,outerRadius:e*1.435,color:7903158,opacity:.075},{innerRadius:e*1.57,outerRadius:e*1.605,color:10403799,opacity:.095},{innerRadius:e*1.78,outerRadius:e*1.82,color:6586526,opacity:.065},{innerRadius:e*2.02,outerRadius:e*2.05,color:11192540,opacity:.05}].forEach((e,t)=>{let n=_d(e);n.name=`Neptune faint ring ${t+1}`,r.add(n)})}return e.add(r),r}function yd(e,t){let n=1180,r=new Float32Array(n*3),i=new Float32Array(n*3),a=new Float32Array(n),o=[new Y(7443125),new Y(11983085),new Y(5073288),new Y(13690868)];for(let e=0;e<n;e+=1){let n=e*3,s=e%3,c=t.radius*(1.8+s*.115)+(Math.random()-.5)*.035,l=Math.random()*Math.PI*2,u=Math.random();u<.5?l=.22+Math.random()*.68:u<.73?l=2.38+Math.random()*.31:u<.88&&(l=4.5+Math.random()*.24),r[n]=Math.cos(l)*c,r[n+1]=(Math.random()-.5)*.018,r[n+2]=Math.sin(l)*c;let d=o[Math.floor(Math.random()*o.length)];i[n]=d.r,i[n+1]=d.g,i[n+2]=d.b,a[e]=.32+Math.random()*.86}let s=new wr;s.setAttribute(`position`,new lr(r,3)),s.setAttribute(`color`,new lr(i,3)),s.setAttribute(`aSize`,new lr(a,1));let c=new qi(s,new Ta({uniforms:{uOpacity:{value:.21}},vertexShader:`
      attribute float aSize;
      varying vec3 vColor;
      void main() {
        vColor = color;
    ...
    `,transparent:!0,vertexColors:!0,blending:2,depthWrite:!1}));return c.name=`Neptune fragmented Adams arcs`,c.rotation.x=Math.PI*.5,c.rotation.z=.07,e.add(c),c}function bd(e,t){let n=t[e.texture]??su(e.texture);return Qu[e.name]?fd(e,n):nd(e,t)}function xd({config:e,textures:t,world:n,orbitRoot:r,planets:i,hoverTargets:a}){let o=Qu[e.name]?[192,128]:e.name===`Mercury`?[192,160]:e.name===`Mars`?[200,168]:e.name===`Venus`?[184,152]:[144,112],s=new ha(e.radius,o[0],o[1]);dd(s,e);let c=new X(s,bd(e,t));if(c.name=e.name,c.userData={name:e.name,orbitRadius:e.orbitRadius,orbitSpeed:e.orbitSpeed,spinSpeed:e.spinSpeed,angle:e.angle,tilt:e.tilt??0,focusScale:e.focusScale??1,focusDistance:e.focusDistance,minFocusDistance:e.minFocusDistance,focusEase:e.focusEase,focusFov:e.focusFov,detail:e.detail,info:e.info,visualLayers:{}},c.rotation.z=e.axialTilt??0,[`Mercury`,`Venus`,`Mars`].includes(e.name)){let t=new X(new ha(e.radius*1.32,24,24),new ei({transparent:!0,opacity:0,depthWrite:!1,colorWrite:!1}));t.name=`${e.name} interaction target`,c.add(t)}let l=md(c,e);return l&&(c.userData.visualLayers.atmosphere=l),e.name===`Venus`&&(c.userData.visualLayers.clouds=gd(c,e,t)),[`Jupiter`,`Saturn`,`Uranus`,`Neptune`].includes(e.name)&&(c.userData.visualLayers.ringSystem=vd(c,e,t)),e.name===`Neptune`&&(c.userData.visualLayers.dustArcs=yd(c,e)),n.add(c),i.push(c),a.push(c),e.orbitRadius>0&&Zu(r,e.orbitRadius,e.orbitColor,e.orbitOpacity??.18,e.tilt??0),c}function Sd(e,t,n=1){e.material?.uniforms?.uTime&&(e.material.uniforms.uTime.value=t);let r=e.userData.visualLayers??{};r.clouds&&(r.clouds.rotation.y+=35e-5*n,r.clouds.children.forEach((e,r)=>{e.material?.uniforms?.uTime&&(e.material.uniforms.uTime.value=t+r*11),r===0&&(e.rotation.y+=.00125*n),r===1&&(e.rotation.y-=72e-5*n),r===2&&(e.rotation.y+=43e-5*n)})),r.atmosphere&&(r.atmosphere.rotation.y-=18e-5*n),r.ringSystem&&(r.ringSystem.rotation.y+=12e-6*n),r.dustArcs&&(r.dustArcs.rotation.z+=85e-6*n)}var Cd=9.2;function wd({color:e,intensity:t,speed:n,power:r,waveScale:i=1}){return new Ta({uniforms:{uTime:{value:0},uColor:{value:new Y(e)},uIntensity:{value:t},uSpeed:{value:n},uPower:{value:r},uWaveScale:{value:i}},vertexShader:`
      varying vec3 vNormalView;
      varying vec3 vViewDirection;
      varying vec3 vObjectDirection;
