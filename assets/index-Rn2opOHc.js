...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fs(e,t,n){let r=new Float32Array(Qo),i=new q(0,1,0);return new wa({name:`SphericalGaussianBlur`,defines:{n:Qo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:hs(),fragmentShader:`
	...
	`}var gs=class extends Ht{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ji(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Vc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Hc(e,t){let n=Vc[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Uc=new q;function Wc(){return Y.getLuminanceCoefficients(Uc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Uc.x.toFixed(4)}, ${Uc.y.toFixed(4)}, ${Uc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
    ...
    `,transparent:!0,vertexColors:!0,blending:2,depthWrite:!1})}function xu(e){let t=[new q(.82,.16,.55).normalize(),new q(.76,.12,.64).normalize(),new q(.69,.22,.69).normalize(),new q(-.71,.33,.62).normalize(),new q(-.64,.26,.72).normalize(),new q(.22,-.58,.78).normalize(),new q(.29,-.52,.8).normalize(),new q(-.38,-.7,-.6).normalize()];return new wa({uniforms:{uTime:{value:0},uMap:{value:e},uGlow:{value:1},uSpotDirections:{value:t},uSpotSizes:{value:[.0048,.0032,.0026,.004,.0027,.0038,.0024,.003]}},vertexShader:`
      uniform float uTime;
    ...
    `,transparent:!1,depthWrite:!0,depthTest:!0})}function Su(e,{count:t,radius:n,position:r,colors:i,size:a,spiral:o=!1,opacity:s=.86}){let c=new Sr,l=new Float32Array(t*3),u=new Float32Array(t*3),d=new Float32Array(t),f=new Float32Array(t),p=new Float32Array(t),m=i.map(e=>new Z(e));for(let e=0;e<t;e+=1){let t=e*3;if(o){let r=e%4,i=Math.random()**.58*n,a=i*.11+r*Math.PI*.5+(Math.random()-.5)*.55;l[t]=Math.cos(a)*i,l[t+1]=(Math.random()-.5)*(1.8+i*.025),l[t+2]=Math.sin(a)*i}else{let e=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1),i=Math.random()**.72*n;l[t]=Math.sin(r)*Math.cos(e)*i,l[t+1]=Math.cos(r)*i*.7,l[t+2]=Math.sin(r)*Math.sin(e)*i}let r=m[Math.floor(Math.random()*m.length)];u[t]=r.r,u[t+1]=r.g,u[t+2]=r.b,d[e]=Math.random()*Math.PI*2,f[e]=.8+Math.random()*3.8,p[e]=.45+Math.random()*1.35}c.setAttribute(`position`,new sr(l,3)),c.setAttribute(`aColor`,new sr(u,3)),c.setAttribute(`aPhase`,new sr(d,1)),c.setAttribute(`aSpeed`,new sr(f,1)),c.setAttribute(`aScale`,new sr(p,1));let h=new Ki(c,bu(a,s));return h.position.copy(r),e.add(h),h}function Cu(e){let t=1800,n=new Sr,r=new Float32Array(t*3),i=new Float32Array(t*3),a=new Float32Array(t),o=new Float32Array(t),s=new Float32Array(t),c=[new Z(`#b6a08b`),new Z(`#706257`),new Z(`#d6c1a6`)];for(let e=0;e<t;e+=1){let t=e*3,n=44+Math.random()*8,l=Math.random()*Math.PI*2;r[t]=Math.cos(l)*n,r[t+1]=(Math.random()-.5)*2.4,r[t+2]=Math.sin(l)*n;let u=c[Math.floor(Math.random()*c.length)];i[t]=u.r,i[t+1]=u.g,i[t+2]=u.b,a[e]=Math.random()*Math.PI*2,o[e]=.25+Math.random()*1.2,s[e]=.25+Math.random()*.8}n.setAttribute(`position`,new sr(r,3)),n.setAttribute(`aColor`,new sr(i,3)),n.setAttribute(`aPhase`,new sr(a,1)),n.setAttribute(`aSpeed`,new sr(o,1)),n.setAttribute(`aScale`,new sr(s,1));let l=new Ki(n,bu(.72,.34));return e.add(l),l}function wu(e,t,n=16777215,r=.18,i=0){let a=Array.from({length:241},(e,n)=>{let r=n/240*Math.PI*2;return new q(Math.cos(r)*t,0,Math.sin(r)*t)}),o=new zi(new Sr().setFromPoints(a),new ji({color:n,transparent:!0,opacity:r}));return o.rotation.x=i,e.add(o),o}var Tu={Jupiter:{cream:new Z(15259058),lightBand:new Z(16773847),darkBand:new Z(4990751),accent:new Z(12084790),polar:new Z(2378599),polarLight:new Z(12114405),bandFrequency:24,fineFrequency:74,turbulence:.145,textureStrength:.35,atmosphereColor:9423840,atmosphereOpacity:.15},Saturn:{cream:new Z(15259309),lightBand:new Z(16772551),darkBand:new Z(9333315),accent:new Z(12094805),polar:new Z(11977655),polarLight:new Z(15199971),bandFrequency:31,fineFrequency:92,turbulence:.045,textureStrength:.65,atmosphereColor:15849895,atmosphereOpacity:.085},Uranus:{cream:new Z(9428452),lightBand:new Z(13170420),darkBand:new Z(5609892),accent:new Z(11070960),polar:new Z(14221311),polarLight:new Z(15794175),bandFrequency:18,fineFrequency:58,turbulence:.026,textureStrength:.48,atmosphereColor:11075583,atmosphereOpacity:.12},Neptune:{cream:new Z(1529800),lightBand:new Z(7518207),darkBand:new Z(400216),accent:new Z(2275539),polar:new Z(2977752),polarLight:new Z(11196927),bandFrequency:24,fineFrequency:88,turbulence:.105,textureStrength:.34,atmosphereColor:6072831,atmosphereOpacity:.18}};function Eu(e,t){let n=t[e.texture]??au(e.texture);return new Ea({map:n,roughness:e.name===`Venus`?.9:.96,metalness:0,bumpMap:e.bump?n:null,bumpScale:e.bump??0,normalMap:e.normalTexture?t[e.normalTexture]:null,normalScale:new K(e.normalScale??.55,e.normalScale??.55),envMapIntensity:.1})}function Du(e,t){let n=Tu[e.name];return new wa({uniforms:{uTime:{value:0},uMap:{value:t},uCream:{value:n.cream},uLightBand:{value:n.lightBand},uDarkBand:{value:n.darkBand},uAccent:{value:n.accent},uPolar:{value:n.polar},uPolarLight:{value:n.polarLight},uBandFrequency:{value:n.bandFrequency},uFineFrequency:{value:n.fineFrequency},uTurbulence:{value:n.turbulence},uTextureStrength:{value:n.textureStrength},uPlanetKind:{value:e.name===`Jupiter`?1:e.name===`Saturn`?2:e.name===`Uranus`?3:4}},vertexShader:`
      varying vec2 vUv;
      varying vec3 vObjectDirection;
    ...
    `,depthWrite:!0,depthTest:!0})}function Ou(e,t){return new wa({uniforms:{uColor:{value:new Z(e)},uOpacity:{value:t}},vertexShader:`
      varying vec3 vNormalView;
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1})}function ku(e,t){let n,r,i;if(t.name===`Venus`)n=16761963,r=.23,i=1.025;else if(Tu[t.name]){let e=Tu[t.name];n=e.atmosphereColor,r=e.atmosphereOpacity,i=t.name===`Jupiter`?1.014:t.name===`Neptune`?1.024:1.018}else if(t.name===`Mars`)n=14183483,r=.055,i=1.012;else if(t.name===`Mercury`)return null;else return null;let a=new ui(new ma(t.radius*i,128,96),Ou(n,r));return a.name=`${t.name} atmosphere`,e.add(a),a}function Au(e,t,n){let r=new ui(new ma(t.radius*1.012,128,96),new Ea({map:n,color:16765594,transparent:!0,opacity:.32,roughness:1,depthWrite:!1}));return r.name=`Venus cloud deck`,e.add(r),r}function ju({innerRadius:e,outerRadius:t,color:n,opacity:r,roughness:i=.9,texture:a=null}){let o=new Ea({map:a,color:n,side:2,transparent:!0,opacity:r,roughness:i,metalness:0,alphaTest:.008,depthWrite:!1}),s=new ui(new pa(e,t,320),o);return s.rotation.x=Math.PI*.5,s}function Mu(e,t,n){let r=new yn;if(r.name=`${t.name} ring system`,t.name===`Saturn`){let e=t.radius,i=n.saturnRing??null;[{innerRadius:e*1.16,outerRadius:e*1.3,color:9271651,opacity:.24},{innerRadius:e*1.31,outerRadius:e*1.49,color:12363651,opacity:.47},{innerRadius:e*1.51,outerRadius:e*1.73,color:15785914,opacity:.91,texture:i},{innerRadius:e*1.79,outerRadius:e*1.96,color:14073750,opacity:.76,texture:i},{innerRadius:e*2.04,outerRadius:e*2.065,color:15918796,opacity:.56}].forEach((e,t)=>{let n=ju(e);n.name=`Saturn ring band ${t+1}`,r.add(n)});let a=ju({innerRadius:e*2.09,outerRadius:e*2.105,color:16775135,opacity:.28});r.add(a)}if(t.name===`Jupiter`){let e=t.radius;[{innerRadius:e*1.2,outerRadius:e*1.28,color:9139819,opacity:.055},{innerRadius:e*1.31,outerRadius:e*1.47,color:10456451,opacity:.04},{innerRadius:e*1.49,outerRadius:e*1.66,color:11772826,opacity:.025}].forEach((e,t)=>{let n=ju(e);n.name=`Jupiter dust ring ${t+1}`,r.add(n)})}if(t.name===`Uranus`){let e=t.radius;[[1.42,.01,7246490,.42],[1.51,.012,9551557,.48],[1.6,.01,6324103,.38],[1.71,.015,12575719,.56],[1.83,.011,7444897,.41],[1.96,.014,13823728,.52],[2.11,.013,9354691,.45]].forEach(([t,n,i,a],o)=>{let s=new Ea({color:i,emissive:new Z(i).multiplyScalar(.16),emissiveIntensity:.42,transparent:!0,opacity:a,roughness:.72,metalness:0,side:2,depthWrite:!1}),c=new ui(new ha(e*t,Math.max(.012,e*n),8,360),s);c.name=`Uranus three-dimensional ring ${o+1}`,c.rotation.x=Math.PI*.5,r.add(c)});let n=ju({innerRadius:e*1.38,outerRadius:e*2.18,color:8894141,opacity:.035,roughness:1});n.name=`Uranus faint ring dust sheet`,r.add(n)}if(t.name===`Neptune`){let e=t.radius;[{innerRadius:e*1.4,outerRadius:e*1.435,color:7903158,opacity:.075},{innerRadius:e*1.57,outerRadius:e*1.605,color:10403799,opacity:.095},{innerRadius:e*1.78,outerRadius:e*1.82,color:6586526,opacity:.065},{innerRadius:e*2.02,outerRadius:e*2.05,color:11192540,opacity:.05}].forEach((e,t)=>{let n=ju(e);n.name=`Neptune faint ring ${t+1}`,r.add(n)})}return e.add(r),r}function Nu(e,t){let n=1180,r=new Float32Array(n*3),i=new Float32Array(n*3),a=new Float32Array(n),o=[new Z(7443125),new Z(11983085),new Z(5073288),new Z(13690868)];for(let e=0;e<n;e+=1){let n=e*3,s=e%3,c=t.radius*(1.8+s*.115)+(Math.random()-.5)*.035,l=Math.random()*Math.PI*2,u=Math.random();u<.5?l=.22+Math.random()*.68:u<.73?l=2.38+Math.random()*.31:u<.88&&(l=4.5+Math.random()*.24),r[n]=Math.cos(l)*c,r[n+1]=(Math.random()-.5)*.018,r[n+2]=Math.sin(l)*c;let d=o[Math.floor(Math.random()*o.length)];i[n]=d.r,i[n+1]=d.g,i[n+2]=d.b,a[e]=.32+Math.random()*.86}let s=new Sr;s.setAttribute(`position`,new sr(r,3)),s.setAttribute(`color`,new sr(i,3)),s.setAttribute(`aSize`,new sr(a,1));let c=new Ki(s,new wa({uniforms:{uOpacity:{value:.21}},vertexShader:`
    ...
    `,transparent:!0,vertexColors:!0,blending:2,depthWrite:!1}));return c.name=`Neptune fragmented Adams arcs`,c.rotation.x=Math.PI*.5,c.rotation.z=.07,e.add(c),c}function Pu(e,t){let n=t[e.texture]??au(e.texture);return Tu[e.name]?Du(e,n):Eu(e,t)}function Fu({config:e,textures:t,world:n,orbitRoot:r,planets:i,hoverTargets:a}){let o=Tu[e.name]?[192,128]:[144,112],s=new ui(new ma(e.radius,o[0],o[1]),Pu(e,t));s.name=e.name,s.userData={name:e.name,orbitRadius:e.orbitRadius,orbitSpeed:e.orbitSpeed,spinSpeed:e.spinSpeed,angle:e.angle,tilt:e.tilt??0,focusScale:e.focusScale??1,detail:e.detail,info:e.info,visualLayers:{}},s.rotation.z=e.axialTilt??0;let c=ku(s,e);return c&&(s.userData.visualLayers.atmosphere=c),e.name===`Venus`&&(s.userData.visualLayers.clouds=Au(s,e,t.venus??au(`venus`))),[`Jupiter`,`Saturn`,`Uranus`,`Neptune`].includes(e.name)&&(s.userData.visualLayers.ringSystem=Mu(s,e,t)),e.name===`Neptune`&&(s.userData.visualLayers.dustArcs=Nu(s,e)),n.add(s),i.push(s),a.push(s),e.orbitRadius>0&&wu(r,e.orbitRadius,e.orbitColor,e.orbitOpacity??.18,e.tilt??0),s}function Iu(e,t,n=1){e.material?.uniforms?.uTime&&(e.material.uniforms.uTime.value=t);let r=e.userData.visualLayers??{};r.clouds&&(r.clouds.rotation.y+=.0016*n),r.atmosphere&&(r.atmosphere.rotation.y-=18e-5*n),r.ringSystem&&(r.ringSystem.rotation.y+=12e-6*n),r.dustArcs&&(r.dustArcs.rotation.z+=85e-6*n)}var Lu=9.2;function Ru({color:e,intensity:t,speed:n,power:r,waveScale:i=1}){return new wa({uniforms:{uTime:{value:0},uColor:{value:new Z(e)},uIntensity:{value:t},uSpeed:{value:n},uPower:{value:r},uWaveScale:{value:i}},vertexShader:`
      varying vec3 vNormalView;
      varying vec3 vViewDirection;
      varying vec3 vObjectDirection;
    ...
    `,transparent:!0,blending:2,depthWrite:!1,depthTest:!0,side:1})}function zu(e,t){let n=St.degToRad(90-e),r=St.degToRad(t);return new q(Math.sin(n)*Math.cos(r),Math.cos(n),Math.sin(n)*Math.sin(r))}function Bu(){let e=new yn;e.name=`Solar spicules`;let t=new na(.024,.34,4,1,!0),n=new Qr({color:16777215,vertexColors:!0,transparent:!0,opacity:.18,blending:2,depthWrite:!1,depthTest:!0,side:2}),r=new q(0,1,0),i=new Si(t,n,560);i.name=`Instanced solar spicules`;let a=new X,o=new Ct,s=new q,c=new q,l=[new Z(16728592),new Z(16739608),new Z(16751140),new Z(16761677)];for(let e=0;e<560;e+=1){let t=1-e/559*2,n=Math.sqrt(1-t*t),u=e*Math.PI*(3-Math.sqrt(5)),d=new q(Math.cos(u)*n,t,Math.sin(u)*n),f=.1+e*37%41/41*.44;c.copy(d).multiplyScalar(Lu+f*.44),o.setFromUnitVectors(r,d),s.set(.44+e%4*.08,f/.34,.44+e%3*.09),a.compose(c,o,s),i.setMatrixAt(e,a),i.setColorAt(e,l[e%l.length])}return i.instanceMatrix.needsUpdate=!0,i.instanceColor&&(i.instanceColor.needsUpdate=!0),e.add(i),e}function Vu(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`);t.save(),t.translate(128,128),t.scale(.72,1);let n=t.createRadialGradient(0,0,0,0,0,128);n.addColorStop(0,`rgba(255, 255, 245, 1)`),n.addColorStop(.08,`rgba(255, 248, 205, 0.98)`),n.addColorStop(.2,`rgba(255, 205, 95, 0.92)`),n.addColorStop(.4,`rgba(255, 111, 22, 0.72)`),n.addColorStop(.64,`rgba(210, 38, 4, 0.34)`),n.addColorStop(.82,`rgba(105, 9, 0, 0.10)`),n.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=n,t.fillRect(-128,-128,256,256),t.restore();let r=new Yi(e);return r.colorSpace=Fe,r.minFilter=o,r.magFilter=o,r.generateMipmaps=!1,r}function Hu({latitude:e,longitude:t,height:n,bend:r,phase:i},a){let o=zu(e,t),s=Math.abs(o.y)>.9?new q(1,0,0):new q(0,1,0),c=new q().crossVectors(s,o).normalize(),l=new yn;l.name=`Solar plasma jet`;let u=[16725256,16731915,16740372,16751909,16762954,16777121],d=Array.from({length:42},(e,t)=>{let n=new Hr(new Or({map:a,color:u[t%u.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/42,n.userData.phase=i+t*1.17,l.add(n),n}),f=new Hr(new Or({map:a,color:16777198,transparent:!0,opacity:.52,blending:2,depthWrite:!1,depthTest:!0}));return f.position.copy(o).multiplyScalar(Lu*1.008),f.scale.set(.46,.46,1),l.add(f),l.userData={direction:o,tangent:c,height:n,bend:r,phase:i,particles:d,core:f},l}function Uu({angle:e,width:t,height:n,tilt:r,phase:i},a){let o=e-t*.5,s=e+t*.5,c=(e,t=Lu*1.008)=>new q(Math.cos(e)*t,0,Math.sin(e)*t),l=c(o),u=c(s),d=(o+s)*.5,f=c(d-t*.18,Lu+n),p=c(d+t*.18,Lu+n);f.y=n*.2,p.y=n*.2;let m=new ua(l,f,p,u),h=new yn;h.name=`Coronal loop`,h.rotation.x=r;let g=[16728848,16740635,16753712,16777123];return h.userData={curve:m,particles:Array.from({length:34},(e,t)=>{let n=new Hr(new Or({map:a,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/34,n.userData.phase=i+t*.93,h.add(n),n}),phase:i},h}function Wu({latitude:e,longitude:t,height:n,width:r,bend:i,phase:a},o){let s=new yn;s.name=`Solar flare`;let c=zu(e,t),l=Math.abs(c.y)>.88?new q(1,0,0):new q(0,1,0),u=new q().crossVectors(l,c).normalize(),d=new q().crossVectors(c,u).normalize(),f=new Hr(new Or({map:o,color:16777170,transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));f.position.copy(c).multiplyScalar(Lu*1.008),f.scale.set(.35,.35,1),s.add(f);let p=c.clone().multiplyScalar(Lu*1.01).addScaledVector(u,-r*.5),m=c.clone().multiplyScalar(Lu*1.01).addScaledVector(u,r*.5),h=new ua(p,c.clone().multiplyScalar(Lu+n).addScaledVector(u,-r*.2).addScaledVector(d,i),c.clone().multiplyScalar(Lu+n).addScaledVector(u,r*.2).addScaledVector(d,i),m),g=[16728592,16740120,16754221,16767068,16777156,16777215],_=Array.from({length:92},(e,t)=>{let n=new Hr(new Or({map:o,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/92,n.userData.phase=a+t*.63,s.add(n),n}),v=Array.from({length:34},(e,t)=>{let n=new Hr(new Or({map:o,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/34,n.userData.angle=t/34*Math.PI*2,n.userData.phase=a+t*1.13,s.add(n),n}),y=new ui(new pa(.72,1,96),new Qr({color:16757575,transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0,side:2}));return y.position.copy(c).multiplyScalar(Lu*1.025),y.quaternion.setFromUnitVectors(new q(0,0,1),c),y.scale.setScalar(.1),s.add(y),s.userData={direction:c,tangent:u,bitangent:d,curve:h,height:n,width:r,bend:i,phase:a,core:f,arcParticles:_,ejectaParticles:v,shockWave:y},s}function Gu({world:e,hoverTargets:t,texture:n}){let r=new yn;r.name=`Sun system`;let i=n??au(`sun`),a=new ui(new ma(Lu,192,128),xu(i));a.name=`Sun`,a.userData={name:`Sun`,detail:`G-type star | 99.86% of solar system mass`,focusScale:1.2,minFocusDistance:28,info:{type:`Star`,diameter:`1,392,700 km`,orbitalSpeed:`System reference body`,distanceFromEarth:`≈ 149.6 million km`,description:`A living ocean of plasma whose magnetic storms, radiant light, and immense gravity sustain every world in this planetary system.`}},r.add(a);let o=new ui(new ma(Lu*1.012,144,96),Ru({color:16739352,intensity:.3,speed:.028,power:3.15,waveScale:18}));o.name=`Solar chromosphere`,r.add(o);let s=new ui(new ma(Lu*1.027,128,88),Ru({color:16749599,intensity:.105,speed:.017,power:4.25,waveScale:11}));s.name=`Inner solar corona`;let c=new ui(new ma(Lu*1.046,112,80),Ru({color:16762194,intensity:.032,speed:-.011,power:5.5,waveScale:8}));c.name=`Outer solar corona`,r.add(s,c);let l=su(),u=Vu(),d=new Hr(new Or({map:l,color:16738328,transparent:!0,opacity:.024,blending:2,depthWrite:!1,depthTest:!0}));d.name=`Solar glow`,d.scale.set(19.2,19.2,1),r.add(d);let f=Bu();r.add(f);let p=[{latitude:-24,longitude:18,height:1.75,bend:.42,phase:.4},{latitude:32,longitude:-48,height:1.15,bend:-.28,phase:1.9},{latitude:8,longitude:72,height:1.45,bend:.31,phase:3.2},{latitude:-46,longitude:-82,height:.95,bend:-.22,phase:4.5}].map(e=>Hu(e,u));r.add(...p);let m=[{angle:2.75,width:.25,height:1.65,tilt:.42,phase:1.2},{angle:5.35,width:.18,height:1.05,tilt:-.58,phase:4.1}].map(e=>Uu(e,u)),h=[{latitude:18,longitude:38,height:3.2,width:1.5,bend:.45,phase:.7},{latitude:-31,longitude:-62,height:2.4,width:1.1,bend:-.34,phase:3.4},{latitude:47,longitude:124,height:2.75,width:1.25,bend:.28,phase:6.2}].map(e=>Wu(e,u));r.add(...h),r.add(...m);let g=new uo(16768416,5600,1600,1.45);return g.name=`Solar point light`,r.add(g),e.add(r),t.push(a),{system:r,surface:a,chromosphere:o,innerCorona:s,outerCorona:c,glow:d,spicules:f,plasmaJets:p,coronalLoops:m,solarFlares:h,light:g}}function Ku(e,t,n=1){e.surface.rotation.y+=.00135*n,e.chromosphere.rotation.y-=42e-5*n,e.innerCorona.rotation.y+=25e-5*n,e.outerCorona.rotation.y-=14e-5*n,e.surface.material.uniforms?.uTime&&(e.surface.material.uniforms.uTime.value=t),e.chromosphere.material.uniforms?.uTime&&(e.chromosphere.material.uniforms.uTime.value=t),e.innerCorona.material.uniforms?.uTime&&(e.innerCorona.material.uniforms.uTime.value=t),e.outerCorona.material.uniforms?.uTime&&(e.outerCorona.material.uniforms.uTime.value=t);let r=1+Math.sin(t*.52)*.012;e.glow.scale.set(19.2*r,19.2*r,1),e.glow.material.opacity=.022+Math.sin(t*.67)*.0035,e.spicules.rotation.y+=34e-5*n,e.spicules.rotation.x=Math.sin(t*.11)*.005;let i=1+Math.sin(t*4.8)*.01;e.spicules.scale.setScalar(i);let a=e.spicules.children[0];a?.material&&(a.material.opacity=.15+Math.sin(t*5.2)*.024),e.plasmaJets.forEach(e=>{let{direction:n,tangent:r,height:i,bend:a,phase:o,particles:s,core:c}=e.userData;c.material.opacity=.25+Math.sin(t*2.8+o)*.09;let l=.39+Math.sin(t*3.4+o)*.055;c.scale.set(l,l,1),s.forEach(e=>{let s=(t*.072+e.userData.offset+o*.05)%1,c=Lu*1.008+s*i,l=Math.sin(Math.PI*s)*a;e.position.copy(n).multiplyScalar(c).addScaledVector(r,l);let u=Math.sin(Math.PI*s)*(1-s*.62),d=Math.sin(t*5.4+e.userData.phase)*u*.075;e.position.addScaledVector(r,d);let f=.78+Math.sin(t*6.2+e.userData.phase)*.22,p=(.09+u*.29)*(.88+f*.18);e.scale.set(p*1.1,p*(1.35+s*.55),1),e.material.opacity=u*(.3+f*.22)})}),e.coronalLoops.forEach(e=>{let{curve:n,particles:r,phase:i}=e.userData;r.forEach(e=>{let r=(e.userData.offset+t*.018)%1,a=n.getPoint(r),o=Math.sin(t*3.6+e.userData.phase+i)*.028;a.y+=o,e.position.copy(a);let s=Math.sin(Math.PI*r),c=.72+Math.sin(t*5.1+e.userData.phase)*.28,l=(.047+s*.125)*(.82+c*.25);e.scale.set(l,l*1.2,1),e.material.opacity=s*(.1+c*.22)})}),e.solarFlares.forEach(e=>{let{direction:r,tangent:i,bitangent:a,curve:o,height:s,phase:c,core:l,arcParticles:u,ejectaParticles:d,shockWave:f}=e.userData,p=(t*.055+c*.13)%1,m=St.smoothstep(p,.05,.18)*(1-St.smoothstep(p,.68,.96)),h=.72+Math.sin(t*9+c)*.28,g=.24+m*.52*h;l.scale.set(g,g,1),l.material.opacity=m*(.36+h*.38),u.forEach(e=>{let n=(e.userData.offset+t*.028)%1,i=o.getPoint(n),s=Math.sin(t*5.8+e.userData.phase)*.045;i.addScaledVector(a,s).addScaledVector(r,s*.25),e.position.copy(i);let c=Math.sin(Math.PI*n),l=.68+Math.sin(t*8.5+e.userData.phase)*.32,u=(.065+c*.17)*(.82+l*.35)*m;e.scale.set(u*1.12,u*1.55,1),e.material.opacity=c*m*(.18+l*.5)}),d.forEach(e=>{let n=(p+e.userData.offset*.42)%1,o=Math.sin(Math.PI*n),c=Lu*1.015+n*s*1.35,l=Math.sin(Math.PI*n)*(.18+n*.85),u=e.userData.angle;e.position.copy(r).multiplyScalar(c).addScaledVector(i,Math.cos(u)*l).addScaledVector(a,Math.sin(u)*l);let d=.66+Math.sin(t*7.2+e.userData.phase)*.34,f=(.035+o*.16)*d*m;e.scale.set(f,f*(1.25+n*.8),1),e.material.opacity=o*m*(.12+d*.34)});let _=St.clamp((p-.15)/.55,0,1),v=.2+_*3.8;f.scale.setScalar(v),f.material.opacity=Math.sin(Math.PI*_)*m*.16,f.rotation.z+=.0015*n})}(async()=>{let e=document.querySelector(`#universe`),t=document.querySelector(`#loader`),n=document.querySelector(`#progress-bar`),r=document.querySelector(`#body-card`),i=document.querySelector(`#body-connector`),a=document.querySelector(`#card-type`),o=document.querySelector(`#card-mode`),s=document.querySelector(`#card-name`),c=document.querySelector(`#card-diameter`),l=document.querySelector(`#card-speed`),u=document.querySelector(`#card-distance`),d=document.querySelector(`#card-description`),f=document.querySelector(`#card-hint`),p=document.querySelector(`#card-close`),m=new On;m.fog=new Dn(66570,.0018);let h=new co(56,innerWidth/innerHeight,.1,5e3),g=new eu({canvas:e,antialias:!0,alpha:!1,powerPreference:`high-performance`});g.setPixelRatio(Math.min(devicePixelRatio,2)),g.setSize(innerWidth,innerHeight),g.outputColorSpace=Fe,g.toneMapping=4,g.toneMappingExposure=1.18;let _=new Io,v=new No,y=new K(-10,-10),b=new yn,x=new yn,S=[],C=[];m.add(b,x);let w=0,T=0,E=-.55,D=.22,O=E,k=D,A=!1,ee={x:0,y:0},j={x:0,y:0},M=0,N=null,P=null,F=null,te=!1,ne=0,re=new q;m.add(new ho(9281990,.34));let ie=new mo(9166079,.75);ie.position.set(-50,40,90),m.add(ie);let ae=await lu(),oe=Gu({world:b,hoverTargets:C,texture:ae.sun});gu.forEach(e=>{Fu({config:e,textures:ae,world:b,orbitRoot:x,planets:S,hoverTargets:C})});let se=S.find(e=>e.name===`Earth`),I=new ui(new ma(1.285,96,96),new Ea({color:16777215,alphaMap:ae.earthClouds??null,transparent:!0,opacity:ae.earthClouds?.44:0,depthWrite:!1,roughness:1}));se.add(I);let ce=new ui(new ma(1.305,96,96),new Qr({color:6020351,transparent:!0,opacity:.18,side:1,blending:2}));if(se.add(ce),ae.earthLights){let e=new ui(new ma(1.265,96,96),new Qr({color:16765818,map:ae.earthLights,transparent:!0,opacity:.52,blending:2,depthWrite:!1}));se.add(e)}let{moon:le,moonPivot:ue}=hu({earth:se,textures:ae,hoverTargets:C}),de=Su(m,{count:6800,radius:1800,position:new q(0,0,0),colors:[`#ffffff`,`#95dcff`,`#ffd38c`,`#ff9ec2`],size:1.55,opacity:.95}),fe=Su(m,{count:11500,radius:320,position:new q(0,-18,0),colors:[`#ffffff`,`#7de7ff`,`#ffd37a`,`#ff7da8`],size:1.15,spiral:!0,opacity:0});fe.rotation.x=.28;let pe=yu(b),me=Cu(b);function he(){let e=document.documentElement.scrollHeight-innerHeight;w=e>0?scrollY/e:0,n&&n.style&&(n.style.width=`${w*100}%`)}function ge(e){let t=e*e*(3-2*e);return St.lerp(4.8,620,t)}function _e(e){return N?N.getWorldPosition(new q):e<18?se.getWorldPosition(new q):new q(0,0,0)}function ve(e){let t=!!e;if(r.classList.toggle(`is-visible`,t),r.setAttribute(`aria-hidden`,String(!t)),!e){P=null,i.classList.remove(`is-visible`);return}if(P!==e){let t=e.userData.info??{};a.textContent=t.type??`Celestial body`,s.textContent=e.userData.name??e.name,c.textContent=t.diameter??`Not available`,l.textContent=t.orbitalSpeed??`Not available`,u.textContent=t.distanceFromEarth??`Not available`,d.textContent=t.description??e.userData.detail??`No description available.`,P=e}let n=N===e;o.textContent=n?`Slow motion · Focused`:`Hover preview`,f.textContent=n?`Slow motion active · Drag to inspect · Click empty space to exit`:`Click to focus · Focus activates slow motion · Then drag to inspect`}function ye(e){if(!e||innerWidth<=760){i.classList.remove(`is-visible`);return}let t=e.getWorldPosition(new q).project(h),n=(t.x*.5+.5)*innerWidth,a=(-t.y*.5+.5)*innerHeight;if(!(t.z>-1&&t.z<1&&n>=0&&n<=innerWidth&&a>=0&&a<=innerHeight)){i.classList.remove(`is-visible`);return}let o=r.getBoundingClientRect(),s=o.left,c=St.clamp(a,o.top+26,o.bottom-26),l=s-n,u=c-a;i.style.left=`${n}px`,i.style.top=`${a}px`,i.style.width=`${Math.hypot(l,u)}px`,i.style.transform=`rotate(${Math.atan2(u,l)}rad)`,i.classList.add(`is-visible`)}function be(){let e=Ce();F&&e!==F&&(F=null);let t=N??e,n=t===F?null:t;document.body.classList.toggle(`is-hovering-body`,!!e),ve(n),ye(n)}p.addEventListener(`click`,()=>{F=P,N=null,ve(null)});function xe(e){y.x=e.clientX/innerWidth*2-1,y.y=-(e.clientY/innerHeight)*2+1}function Se(e){for(;e;){if(e.userData?.name)return e;e=e.parent}return null}function Ce(){v.setFromCamera(y,h);let e=v.intersectObjects(C,!0).map(e=>Se(e.object)).filter(Boolean);return e.find(e=>e.userData?.info?.type===`Natural satellite`)??e[0]??null}function we(e){if(!e){N=null;return}if(N=N===e?null:e,!N)return;let t=e.userData.orbitRadius??e.getWorldPosition(new q).length(),n=St.clamp(t/230,.035,.72);window.scrollTo({top:n*(document.documentElement.scrollHeight-innerHeight),behavior:`smooth`})}addEventListener(`scroll`,he,{passive:!0}),addEventListener(`pointermove`,e=>{xe(e),A?(M=Math.max(M,Math.hypot(e.clientX-j.x,e.clientY-j.y)),E-=(e.clientX-ee.x)*.006,D-=(e.clientY-ee.y)*.004,D=St.clamp(D,-1.1,1.1)):(E+=y.x*5e-4,D+=y.y*25e-5),ee={x:e.clientX,y:e.clientY}}),addEventListener(`pointerdown`,e=>{xe(e),A=!0,M=0,j={x:e.clientX,y:e.clientY},ee={x:e.clientX,y:e.clientY}}),addEventListener(`pointerup`,e=>{xe(e),A=!1,!(e.target.closest?.(`.hud, .body-card`)||M>12)&&we(Ce()||null)}),addEventListener(`pointercancel`,()=>{A=!1}),addEventListener(`keydown`,e=>{e.key===`Escape`&&(N=null),e.key===`ArrowLeft`&&(E+=.18),e.key===`ArrowRight`&&(E-=.18),e.key===`ArrowUp`&&(D=St.clamp(D+.12,-1.1,1.1)),e.key===`ArrowDown`&&(D=St.clamp(D-.12,-1.1,1.1))}),addEventListener(`resize`,()=>{h.aspect=innerWidth/innerHeight,h.updateProjectionMatrix(),g.setSize(innerWidth,innerHeight)});function Te(){let e=_.getElapsedTime(),t=N?.12:1;ne+=.016*t,T=St.lerp(T,w,.065),O=St.lerp(O,E,.075),k=St.lerp(k,D,.075),S.forEach(e=>{let n=e.userData;n.angle+=n.orbitSpeed*.0024*t,e.position.set(Math.cos(n.angle)*n.orbitRadius,Math.sin(n.angle*.7)*Math.sin(n.tilt)*1.8,Math.sin(n.angle)*n.orbitRadius),e.rotation.y+=n.spinSpeed*t,Iu(e,ne,t)});let n=ge(T),r=_e(n);te||=(re.copy(r),!0),re.lerp(r,N?.055:.075);let i=N?.userData?.focusScale??1,a=N?.userData?.minFocusDistance??4.5,o=N?Math.max(a,Math.min(n,30/i)):n,s=Math.cos(k)*Math.sin(O)*o,c=Math.sin(k)*o*.64,l=Math.cos(k)*Math.cos(O)*o;h.position.set(re.x+s,re.y+c,re.z+l),h.lookAt(re),h.fov=St.lerp(h.fov,St.lerp(42,68,T),.04),h.updateProjectionMatrix(),I.rotation.y+=.0032,ce.rotation.y-=.0014,ue.rotation.y+=.011*t,le.rotation.y=Math.sin(ne*.35)*.04,Ku(oe,ne,t),pe.rotation.y+=.001*t,pe.children.forEach(e=>{e.rotation.x+=e.userData.spin.x*t,e.rotation.y+=e.userData.spin.y*t,e.rotation.z+=e.userData.spin.z*t}),me.rotation.y-=7e-4*t,de.rotation.y+=8e-5*t,fe.rotation.y+=45e-5*t,de.material.uniforms.uTime.value=e,me.material.uniforms.uTime.value=e,fe.material.uniforms.uTime.value=e*.72,fe.material.uniforms.uOpacity.value=St.clamp((T-.54)/.34,0,1)*.9,x.children.forEach(e=>{e.material.opacity=St.clamp((T-.035)/.18,.04,.22)}),h.updateMatrixWorld(),be(),g.render(m,h),requestAnimationFrame(Te)}he(),Te(),setTimeout(()=>{t.classList.add(`is-hidden`)},1350)})();