...
void main() {
    ...
    `,depthWrite:!0,depthTest:!0})}function Uu(e,t){return new Ta({uniforms:{uColor:{value:new Y(e)},uOpacity:{value:t}},vertexShader:`
      varying vec3 vNormalView;
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:1})}function Wu(e,t){let n,r,i;if(t.name===`Venus`)n=16761963,r=.23,i=1.025;else if(Bu[t.name]){let e=Bu[t.name];n=e.atmosphereColor,r=e.atmosphereOpacity,i=t.name===`Jupiter`?1.014:t.name===`Neptune`?1.024:1.018}else if(t.name===`Mars`)n=14183483,r=.055,i=1.012;else if(t.name===`Mercury`)return null;else return null;let a=new di(new ha(t.radius*i,128,96),Uu(n,r));return a.name=`${t.name} atmosphere`,e.add(a),a}function Gu(e,t,n){let r=new di(new ha(t.radius*1.012,128,96),new Da({map:n,color:16765594,transparent:!0,opacity:.32,roughness:1,depthWrite:!1}));return r.name=`Venus cloud deck`,e.add(r),r}function Ku({innerRadius:e,outerRadius:t,color:n,opacity:r,roughness:i=.9,texture:a=null}){let o=new Da({map:a,color:n,side:2,transparent:!0,opacity:r,roughness:i,metalness:0,alphaTest:.008,depthWrite:!1}),s=new di(new ma(e,t,320),o);return s.rotation.x=Math.PI*.5,s}function qu(e,t,n){let r=new xn;if(r.name=`${t.name} ring system`,t.name===`Saturn`){let e=t.radius,i=n.saturnRing??null;[{innerRadius:e*1.16,outerRadius:e*1.3,color:9271651,opacity:.24},{innerRadius:e*1.31,outerRadius:e*1.49,color:12363651,opacity:.47},{innerRadius:e*1.51,outerRadius:e*1.73,color:15785914,opacity:.91,texture:i},{innerRadius:e*1.79,outerRadius:e*1.96,color:14073750,opacity:.76,texture:i},{innerRadius:e*2.04,outerRadius:e*2.065,color:15918796,opacity:.56}].forEach((e,t)=>{let n=Ku(e);n.name=`Saturn ring band ${t+1}`,r.add(n)});let a=Ku({innerRadius:e*2.09,outerRadius:e*2.105,color:16775135,opacity:.28});r.add(a)}if(t.name===`Jupiter`){let e=t.radius;[{innerRadius:e*1.2,outerRadius:e*1.28,color:9139819,opacity:.055},{innerRadius:e*1.31,outerRadius:e*1.47,color:10456451,opacity:.04},{innerRadius:e*1.49,outerRadius:e*1.66,color:11772826,opacity:.025}].forEach((e,t)=>{let n=Ku(e);n.name=`Jupiter dust ring ${t+1}`,r.add(n)})}if(t.name===`Uranus`){let e=t.radius;[[1.42,.01,7246490,.42],[1.51,.012,9551557,.48],[1.6,.01,6324103,.38],[1.71,.015,12575719,.56],[1.83,.011,7444897,.41],[1.96,.014,13823728,.52],[2.11,.013,9354691,.45]].forEach(([t,n,i,a],o)=>{let s=new Da({color:i,emissive:new Y(i).multiplyScalar(.16),emissiveIntensity:.42,transparent:!0,opacity:a,roughness:.72,metalness:0,side:2,depthWrite:!1}),c=new di(new ga(e*t,Math.max(.012,e*n),8,360),s);c.name=`Uranus three-dimensional ring ${o+1}`,c.rotation.x=Math.PI*.5,r.add(c)});let n=Ku({innerRadius:e*1.38,outerRadius:e*2.18,color:8894141,opacity:.035,roughness:1});n.name=`Uranus faint ring dust sheet`,r.add(n)}if(t.name===`Neptune`){let e=t.radius;[{innerRadius:e*1.4,outerRadius:e*1.435,color:7903158,opacity:.075},{innerRadius:e*1.57,outerRadius:e*1.605,color:10403799,opacity:.095},{innerRadius:e*1.78,outerRadius:e*1.82,color:6586526,opacity:.065},{innerRadius:e*2.02,outerRadius:e*2.05,color:11192540,opacity:.05}].forEach((e,t)=>{let n=Ku(e);n.name=`Neptune faint ring ${t+1}`,r.add(n)})}return e.add(r),r}function Ju(e,t){let n=1180,r=new Float32Array(n*3),i=new Float32Array(n*3),a=new Float32Array(n),o=[new Y(7443125),new Y(11983085),new Y(5073288),new Y(13690868)];for(let e=0;e<n;e+=1){let n=e*3,s=e%3,c=t.radius*(1.8+s*.115)+(Math.random()-.5)*.035,l=Math.random()*Math.PI*2,u=Math.random();u<.5?l=.22+Math.random()*.68:u<.73?l=2.38+Math.random()*.31:u<.88&&(l=4.5+Math.random()*.24),r[n]=Math.cos(l)*c,r[n+1]=(Math.random()-.5)*.018,r[n+2]=Math.sin(l)*c;let d=o[Math.floor(Math.random()*o.length)];i[n]=d.r,i[n+1]=d.g,i[n+2]=d.b,a[e]=.32+Math.random()*.86}let s=new Cr;s.setAttribute(`position`,new lr(r,3)),s.setAttribute(`color`,new lr(i,3)),s.setAttribute(`aSize`,new lr(a,1));let c=new qi(s,new Ta({uniforms:{uOpacity:{value:.21}},vertexShader:`
    ...
    `,transparent:!0,vertexColors:!0,blending:2,depthWrite:!1}));return c.name=`Neptune fragmented Adams arcs`,c.rotation.x=Math.PI*.5,c.rotation.z=.07,e.add(c),c}function Yu(e,t){let n=t[e.texture]??ou(e.texture);return Bu[e.name]?Hu(e,n):Vu(e,t)}function Xu({config:e,textures:t,world:n,orbitRoot:r,planets:i,hoverTargets:a}){let o=Bu[e.name]?[192,128]:[144,112],s=new di(new ha(e.radius,o[0],o[1]),Yu(e,t));s.name=e.name,s.userData={name:e.name,orbitRadius:e.orbitRadius,orbitSpeed:e.orbitSpeed,spinSpeed:e.spinSpeed,angle:e.angle,tilt:e.tilt??0,focusScale:e.focusScale??1,detail:e.detail,info:e.info,visualLayers:{}},s.rotation.z=e.axialTilt??0;let c=Wu(s,e);return c&&(s.userData.visualLayers.atmosphere=c),e.name===`Venus`&&(s.userData.visualLayers.clouds=Gu(s,e,t.venus??ou(`venus`))),[`Jupiter`,`Saturn`,`Uranus`,`Neptune`].includes(e.name)&&(s.userData.visualLayers.ringSystem=qu(s,e,t)),e.name===`Neptune`&&(s.userData.visualLayers.dustArcs=Ju(s,e)),n.add(s),i.push(s),a.push(s),e.orbitRadius>0&&zu(r,e.orbitRadius,e.orbitColor,e.orbitOpacity??.18,e.tilt??0),s}function Zu(e,t,n=1){e.material?.uniforms?.uTime&&(e.material.uniforms.uTime.value=t);let r=e.userData.visualLayers??{};r.clouds&&(r.clouds.rotation.y+=.0016*n),r.atmosphere&&(r.atmosphere.rotation.y-=18e-5*n),r.ringSystem&&(r.ringSystem.rotation.y+=12e-6*n),r.dustArcs&&(r.dustArcs.rotation.z+=85e-6*n)}var Qu=9.2;function $u({color:e,intensity:t,speed:n,power:r,waveScale:i=1}){return new Ta({uniforms:{uTime:{value:0},uColor:{value:new Y(e)},uIntensity:{value:t},uSpeed:{value:n},uPower:{value:r},uWaveScale:{value:i}},vertexShader:`
      varying vec3 vNormalView;
      varying vec3 vViewDirection;
      varying vec3 vObjectDirection;
    ...
    `,transparent:!0,blending:2,depthWrite:!1,depthTest:!0,side:1})}function ed(e,t){let n=W.degToRad(90-e),r=W.degToRad(t);return new K(Math.sin(n)*Math.cos(r),Math.cos(n),Math.sin(n)*Math.sin(r))}function td(){let e=new xn;e.name=`Solar spicules`;let t=new ra(.024,.34,4,1,!0),n=new $r({color:16777215,vertexColors:!0,transparent:!0,opacity:.18,blending:2,depthWrite:!1,depthTest:!0,side:2}),r=new K(0,1,0),i=new Ci(t,n,560);i.name=`Instanced solar spicules`;let a=new Kt,o=new wt,s=new K,c=new K,l=[new Y(16728592),new Y(16739608),new Y(16751140),new Y(16761677)];for(let e=0;e<560;e+=1){let t=1-e/559*2,n=Math.sqrt(1-t*t),u=e*Math.PI*(3-Math.sqrt(5)),d=new K(Math.cos(u)*n,t,Math.sin(u)*n),f=.1+e*37%41/41*.44;c.copy(d).multiplyScalar(Qu+f*.44),o.setFromUnitVectors(r,d),s.set(.44+e%4*.08,f/.34,.44+e%3*.09),a.compose(c,o,s),i.setMatrixAt(e,a),i.setColorAt(e,l[e%l.length])}return i.instanceMatrix.needsUpdate=!0,i.instanceColor&&(i.instanceColor.needsUpdate=!0),e.add(i),e}function nd(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`);t.save(),t.translate(128,128),t.scale(.72,1);let n=t.createRadialGradient(0,0,0,0,0,128);n.addColorStop(0,`rgba(255, 255, 245, 1)`),n.addColorStop(.08,`rgba(255, 248, 205, 0.98)`),n.addColorStop(.2,`rgba(255, 205, 95, 0.92)`),n.addColorStop(.4,`rgba(255, 111, 22, 0.72)`),n.addColorStop(.64,`rgba(210, 38, 4, 0.34)`),n.addColorStop(.82,`rgba(105, 9, 0, 0.10)`),n.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=n,t.fillRect(-128,-128,256,256),t.restore();let r=new Xi(e);return r.colorSpace=Le,r.minFilter=o,r.magFilter=o,r.generateMipmaps=!1,r}function rd({latitude:e,longitude:t,height:n,bend:r,phase:i},a){let o=ed(e,t),s=Math.abs(o.y)>.9?new K(1,0,0):new K(0,1,0),c=new K().crossVectors(s,o).normalize(),l=new xn;l.name=`Solar plasma jet`;let u=[16725256,16731915,16740372,16751909,16762954,16777121],d=Array.from({length:42},(e,t)=>{let n=new Ur(new kr({map:a,color:u[t%u.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/42,n.userData.phase=i+t*1.17,l.add(n),n}),f=new Ur(new kr({map:a,color:16777198,transparent:!0,opacity:.52,blending:2,depthWrite:!1,depthTest:!0}));return f.position.copy(o).multiplyScalar(Qu*1.008),f.scale.set(.46,.46,1),l.add(f),l.userData={direction:o,tangent:c,height:n,bend:r,phase:i,particles:d,core:f},l}function id({angle:e,width:t,height:n,tilt:r,phase:i},a){let o=e-t*.5,s=e+t*.5,c=(e,t=Qu*1.008)=>new K(Math.cos(e)*t,0,Math.sin(e)*t),l=c(o),u=c(s),d=(o+s)*.5,f=c(d-t*.18,Qu+n),p=c(d+t*.18,Qu+n);f.y=n*.2,p.y=n*.2;let m=new da(l,f,p,u),h=new xn;h.name=`Coronal loop`,h.rotation.x=r;let g=[16728848,16740635,16753712,16777123];return h.userData={curve:m,particles:Array.from({length:34},(e,t)=>{let n=new Ur(new kr({map:a,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/34,n.userData.phase=i+t*.93,h.add(n),n}),phase:i},h}function ad({latitude:e,longitude:t,height:n,width:r,bend:i,phase:a},o){let s=new xn;s.name=`Solar flare`;let c=ed(e,t),l=Math.abs(c.y)>.88?new K(1,0,0):new K(0,1,0),u=new K().crossVectors(l,c).normalize(),d=new K().crossVectors(c,u).normalize(),f=new Ur(new kr({map:o,color:16777170,transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));f.position.copy(c).multiplyScalar(Qu*1.008),f.scale.set(.35,.35,1),s.add(f);let p=c.clone().multiplyScalar(Qu*1.01).addScaledVector(u,-r*.5),m=c.clone().multiplyScalar(Qu*1.01).addScaledVector(u,r*.5),h=new da(p,c.clone().multiplyScalar(Qu+n).addScaledVector(u,-r*.2).addScaledVector(d,i),c.clone().multiplyScalar(Qu+n).addScaledVector(u,r*.2).addScaledVector(d,i),m),g=[16728592,16740120,16754221,16767068,16777156,16777215],_=Array.from({length:92},(e,t)=>{let n=new Ur(new kr({map:o,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/92,n.userData.phase=a+t*.63,s.add(n),n}),v=Array.from({length:34},(e,t)=>{let n=new Ur(new kr({map:o,color:g[t%g.length],transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0}));return n.userData.offset=t/34,n.userData.angle=t/34*Math.PI*2,n.userData.phase=a+t*1.13,s.add(n),n}),y=new di(new ma(.72,1,96),new $r({color:16757575,transparent:!0,opacity:0,blending:2,depthWrite:!1,depthTest:!0,side:2}));return y.position.copy(c).multiplyScalar(Qu*1.025),y.quaternion.setFromUnitVectors(new K(0,0,1),c),y.scale.setScalar(.1),s.add(y),s.userData={direction:c,tangent:u,bitangent:d,curve:h,height:n,width:r,bend:i,phase:a,core:f,arcParticles:_,ejectaParticles:v,shockWave:y},s}function od({world:e,hoverTargets:t,texture:n}){let r=new xn;r.name=`Sun system`;let i=n??ou(`sun`),a=new di(new ha(Qu,192,128),Lu(i));a.name=`Sun`,a.userData={name:`Sun`,detail:`G-type star | 99.86% of solar system mass`,focusScale:1.2,minFocusDistance:28,info:{type:`Star`,diameter:`1,392,700 km`,orbitalSpeed:`System reference body`,distanceFromEarth:`≈ 149.6 million km`,description:`A living ocean of plasma whose magnetic storms, radiant light, and immense gravity sustain every world in this planetary system.`}},r.add(a);let o=new di(new ha(Qu*1.012,144,96),$u({color:16739352,intensity:.3,speed:.028,power:3.15,waveScale:18}));o.name=`Solar chromosphere`,r.add(o);let s=new di(new ha(Qu*1.027,128,88),$u({color:16749599,intensity:.105,speed:.017,power:4.25,waveScale:11}));s.name=`Inner solar corona`;let c=new di(new ha(Qu*1.046,112,80),$u({color:16762194,intensity:.032,speed:-.011,power:5.5,waveScale:8}));c.name=`Outer solar corona`,r.add(s,c);let l=cu(),u=nd(),d=new Ur(new kr({map:l,color:16738328,transparent:!0,opacity:.024,blending:2,depthWrite:!1,depthTest:!0}));d.name=`Solar glow`,d.scale.set(19.2,19.2,1),r.add(d);let f=td();r.add(f);let p=[{latitude:-24,longitude:18,height:1.75,bend:.42,phase:.4},{latitude:32,longitude:-48,height:1.15,bend:-.28,phase:1.9},{latitude:8,longitude:72,height:1.45,bend:.31,phase:3.2},{latitude:-46,longitude:-82,height:.95,bend:-.22,phase:4.5}].map(e=>rd(e,u));r.add(...p);let m=[{angle:2.75,width:.25,height:1.65,tilt:.42,phase:1.2},{angle:5.35,width:.18,height:1.05,tilt:-.58,phase:4.1}].map(e=>id(e,u)),h=[{latitude:18,longitude:38,height:3.2,width:1.5,bend:.45,phase:.7},{latitude:-31,longitude:-62,height:2.4,width:1.1,bend:-.34,phase:3.4},{latitude:47,longitude:124,height:2.75,width:1.25,bend:.28,phase:6.2}].map(e=>ad(e,u));r.add(...h),r.add(...m);let g=new fo(16768416,5600,1600,1.45);return g.name=`Solar point light`,r.add(g),e.add(r),t.push(a),{system:r,surface:a,chromosphere:o,innerCorona:s,outerCorona:c,glow:d,spicules:f,plasmaJets:p,coronalLoops:m,solarFlares:h,light:g}}function sd(e,t,n=1){e.surface.rotation.y+=.00135*n,e.chromosphere.rotation.y-=42e-5*n,e.innerCorona.rotation.y+=25e-5*n,e.outerCorona.rotation.y-=14e-5*n,e.surface.material.uniforms?.uTime&&(e.surface.material.uniforms.uTime.value=t),e.chromosphere.material.uniforms?.uTime&&(e.chromosphere.material.uniforms.uTime.value=t),e.innerCorona.material.uniforms?.uTime&&(e.innerCorona.material.uniforms.uTime.value=t),e.outerCorona.material.uniforms?.uTime&&(e.outerCorona.material.uniforms.uTime.value=t);let r=1+Math.sin(t*.52)*.012;e.glow.scale.set(19.2*r,19.2*r,1),e.glow.material.opacity=.022+Math.sin(t*.67)*.0035,e.spicules.rotation.y+=34e-5*n,e.spicules.rotation.x=Math.sin(t*.11)*.005;let i=1+Math.sin(t*4.8)*.01;e.spicules.scale.setScalar(i);let a=e.spicules.children[0];a?.material&&(a.material.opacity=.15+Math.sin(t*5.2)*.024),e.plasmaJets.forEach(e=>{let{direction:n,tangent:r,height:i,bend:a,phase:o,particles:s,core:c}=e.userData;c.material.opacity=.25+Math.sin(t*2.8+o)*.09;let l=.39+Math.sin(t*3.4+o)*.055;c.scale.set(l,l,1),s.forEach(e=>{let s=(t*.072+e.userData.offset+o*.05)%1,c=Qu*1.008+s*i,l=Math.sin(Math.PI*s)*a;e.position.copy(n).multiplyScalar(c).addScaledVector(r,l);let u=Math.sin(Math.PI*s)*(1-s*.62),d=Math.sin(t*5.4+e.userData.phase)*u*.075;e.position.addScaledVector(r,d);let f=.78+Math.sin(t*6.2+e.userData.phase)*.22,p=(.09+u*.29)*(.88+f*.18);e.scale.set(p*1.1,p*(1.35+s*.55),1),e.material.opacity=u*(.3+f*.22)})}),e.coronalLoops.forEach(e=>{let{curve:n,particles:r,phase:i}=e.userData;r.forEach(e=>{let r=(e.userData.offset+t*.018)%1,a=n.getPoint(r),o=Math.sin(t*3.6+e.userData.phase+i)*.028;a.y+=o,e.position.copy(a);let s=Math.sin(Math.PI*r),c=.72+Math.sin(t*5.1+e.userData.phase)*.28,l=(.047+s*.125)*(.82+c*.25);e.scale.set(l,l*1.2,1),e.material.opacity=s*(.1+c*.22)})}),e.solarFlares.forEach(e=>{let{direction:r,tangent:i,bitangent:a,curve:o,height:s,phase:c,core:l,arcParticles:u,ejectaParticles:d,shockWave:f}=e.userData,p=(t*.055+c*.13)%1,m=W.smoothstep(p,.05,.18)*(1-W.smoothstep(p,.68,.96)),h=.72+Math.sin(t*9+c)*.28,g=.24+m*.52*h;l.scale.set(g,g,1),l.material.opacity=m*(.36+h*.38),u.forEach(e=>{let n=(e.userData.offset+t*.028)%1,i=o.getPoint(n),s=Math.sin(t*5.8+e.userData.phase)*.045;i.addScaledVector(a,s).addScaledVector(r,s*.25),e.position.copy(i);let c=Math.sin(Math.PI*n),l=.68+Math.sin(t*8.5+e.userData.phase)*.32,u=(.065+c*.17)*(.82+l*.35)*m;e.scale.set(u*1.12,u*1.55,1),e.material.opacity=c*m*(.18+l*.5)}),d.forEach(e=>{let n=(p+e.userData.offset*.42)%1,o=Math.sin(Math.PI*n),c=Qu*1.015+n*s*1.35,l=Math.sin(Math.PI*n)*(.18+n*.85),u=e.userData.angle;e.position.copy(r).multiplyScalar(c).addScaledVector(i,Math.cos(u)*l).addScaledVector(a,Math.sin(u)*l);let d=.66+Math.sin(t*7.2+e.userData.phase)*.34,f=(.035+o*.16)*d*m;e.scale.set(f,f*(1.25+n*.8),1),e.material.opacity=o*m*(.12+d*.34)});let _=W.clamp((p-.15)/.55,0,1),v=.2+_*3.8;f.scale.setScalar(v),f.material.opacity=Math.sin(Math.PI*_)*m*.16,f.rotation.z+=.0015*n})}(async()=>{let e=document.querySelector(`#universe`),t=document.querySelector(`#loader`),n=document.querySelector(`#progress-bar`),r=document.querySelector(`#body-card`),i=document.querySelector(`#body-connector`),a=document.querySelector(`#card-type`),o=document.querySelector(`#card-mode`),s=document.querySelector(`#card-name`),c=document.querySelector(`#card-diameter`),l=document.querySelector(`#card-speed`),u=document.querySelector(`#card-distance`),d=document.querySelector(`#card-description`),f=document.querySelector(`#card-hint`),p=document.querySelector(`#card-close`),m=new An;m.fog=new kn(66570,.0018);let h=new lo(56,innerWidth/innerHeight,.1,5e3),g=new tu({canvas:e,antialias:!0,alpha:!1,powerPreference:`high-performance`});g.setPixelRatio(Math.min(devicePixelRatio,2)),g.setSize(innerWidth,innerHeight),g.outputColorSpace=Le,g.toneMapping=4,g.toneMappingExposure=1.18;let _=new Lo,v=new Po,y=new G(-10,-10),b=new xn,x=new xn,S=[],C=[];m.add(b,x);let w=0,T=0,E=-.55,D=.22,ee=E,O=D,k=!1,te={x:0,y:0},A={x:0,y:0},j=0,M=null,N=null,P=null,ne=!1,re=0,ie=new K;m.add(new go(9281990,.34));let ae=new ho(9166079,.75);ae.position.set(-50,40,90),m.add(ae);let oe=await uu(),se=od({world:b,hoverTargets:C,texture:oe.sun});_u.forEach(e=>{Xu({config:e,textures:oe,world:b,orbitRoot:x,planets:S,hoverTargets:C})});let ce=S.find(e=>e.name===`Earth`),F=new di(new ha(1.285,96,96),new Da({color:16777215,alphaMap:oe.earthClouds??null,transparent:!0,opacity:oe.earthClouds?.44:0,depthWrite:!1,roughness:1}));ce.add(F);let le=new di(new ha(1.305,96,96),new $r({color:6020351,transparent:!0,opacity:.18,side:1,blending:2}));if(ce.add(le),oe.earthLights){let e=new di(new ha(1.265,96,96),new $r({color:16765818,map:oe.earthLights,transparent:!0,opacity:.52,blending:2,depthWrite:!1}));ce.add(e)}let{moon:ue,moonPivot:de}=gu({earth:ce,textures:oe,hoverTargets:C}),fe=Ru(m,{count:6800,radius:1800,position:new K(0,0,0),colors:[`#ffffff`,`#95dcff`,`#ffd38c`,`#ff9ec2`],size:1.55,opacity:.95}),pe=Ru(m,{count:11500,radius:320,position:new K(0,-18,0),colors:[`#ffffff`,`#7de7ff`,`#ffd37a`,`#ff7da8`],size:1.15,spiral:!0,opacity:0});pe.rotation.x=.28;let me=Pu({world:b,hoverTargets:C}),he=S.find(e=>e.name===`Jupiter`);function ge(){let e=document.documentElement.scrollHeight-innerHeight;w=e>0?scrollY/e:0,n&&n.style&&(n.style.width=`${w*100}%`)}function _e(e){let t=e*e*(3-2*e);return W.lerp(4.8,620,t)}function ve(e){return M?M.getWorldPosition(new K):e<18?ce.getWorldPosition(new K):new K(0,0,0)}function ye(e){let t=!!e;if(r.classList.toggle(`is-visible`,t),r.setAttribute(`aria-hidden`,String(!t)),!e){N=null,i.classList.remove(`is-visible`);return}if(N!==e){let t=e.userData.info??{};a.textContent=t.type??`Celestial body`,s.textContent=e.userData.name??e.name,c.textContent=t.diameter??`Not available`,l.textContent=t.orbitalSpeed??`Not available`,u.textContent=t.distanceFromEarth??`Not available`,d.textContent=t.description??e.userData.detail??`No description available.`,N=e}let n=M===e;o.textContent=n?`Slow motion · Focused`:`Hover preview`,f.textContent=n?`Slow motion active · Drag to inspect · Click empty space to exit`:`Click to focus · Focus activates slow motion · Then drag to inspect`}function be(e){if(!e||innerWidth<=760){i.classList.remove(`is-visible`);return}let t=e.getWorldPosition(new K).project(h),n=(t.x*.5+.5)*innerWidth,a=(-t.y*.5+.5)*innerHeight;if(!(t.z>-1&&t.z<1&&n>=0&&n<=innerWidth&&a>=0&&a<=innerHeight)){i.classList.remove(`is-visible`);return}let o=r.getBoundingClientRect(),s=o.left,c=W.clamp(a,o.top+26,o.bottom-26),l=s-n,u=c-a;i.style.left=`${n}px`,i.style.top=`${a}px`,i.style.width=`${Math.hypot(l,u)}px`,i.style.transform=`rotate(${Math.atan2(u,l)}rad)`,i.classList.add(`is-visible`)}function xe(){let e=we();P&&e!==P&&(P=null);let t=M??e,n=t===P?null:t;document.body.classList.toggle(`is-hovering-body`,!!e),ye(n),be(n)}p.addEventListener(`click`,()=>{P=N,M=null,ye(null)});function Se(e){y.x=e.clientX/innerWidth*2-1,y.y=-(e.clientY/innerHeight)*2+1}function Ce(e){for(;e;){if(e.userData?.name)return e;e=e.parent}return null}function we(){v.setFromCamera(y,h);let e=v.intersectObjects(C,!0).map(e=>Ce(e.object)).filter(Boolean);return e.find(e=>e.userData?.info?.type===`Natural satellite`)??e[0]??null}function Te(e){if(!e){M=null;return}if(M=M===e?null:e,!M)return;let t=e.userData.orbitRadius??e.getWorldPosition(new K).length(),n=W.clamp(t/230,.035,.72);window.scrollTo({top:n*(document.documentElement.scrollHeight-innerHeight),behavior:`smooth`})}addEventListener(`scroll`,ge,{passive:!0}),addEventListener(`pointermove`,e=>{Se(e),k?(j=Math.max(j,Math.hypot(e.clientX-A.x,e.clientY-A.y)),E-=(e.clientX-te.x)*.006,D-=(e.clientY-te.y)*.004,D=W.clamp(D,-1.1,1.1)):(E+=y.x*5e-4,D+=y.y*25e-5),te={x:e.clientX,y:e.clientY}}),addEventListener(`pointerdown`,e=>{Se(e),k=!0,j=0,A={x:e.clientX,y:e.clientY},te={x:e.clientX,y:e.clientY}}),addEventListener(`pointerup`,e=>{Se(e),k=!1,!(e.target.closest?.(`.hud, .body-card`)||j>12)&&Te(we()||null)}),addEventListener(`pointercancel`,()=>{k=!1}),addEventListener(`keydown`,e=>{e.key===`Escape`&&(M=null),e.key===`ArrowLeft`&&(E+=.18),e.key===`ArrowRight`&&(E-=.18),e.key===`ArrowUp`&&(D=W.clamp(D+.12,-1.1,1.1)),e.key===`ArrowDown`&&(D=W.clamp(D-.12,-1.1,1.1))}),addEventListener(`resize`,()=>{h.aspect=innerWidth/innerHeight,h.updateProjectionMatrix(),g.setSize(innerWidth,innerHeight)});function Ee(){let e=_.getElapsedTime(),t=M?.12:1;re+=.016*t,T=W.lerp(T,w,.065),ee=W.lerp(ee,E,.075),O=W.lerp(O,D,.075),S.forEach(e=>{let n=e.userData;n.angle+=n.orbitSpeed*.0024*t,e.position.set(Math.cos(n.angle)*n.orbitRadius,Math.sin(n.angle*.7)*Math.sin(n.tilt)*1.8,Math.sin(n.angle)*n.orbitRadius),e.rotation.y+=n.spinSpeed*t,Zu(e,re,t)});let n=_e(T),r=ve(n);ne||=(ie.copy(r),!0),ie.lerp(r,M?.055:.075);let i=M?.userData?.focusScale??1,a=M?.userData?.minFocusDistance??4.5,o=M?Math.max(a,Math.min(n,30/i)):n,s=Math.cos(O)*Math.sin(ee)*o,c=Math.sin(O)*o*.64,l=Math.cos(O)*Math.cos(ee)*o;h.position.set(ie.x+s,ie.y+c,ie.z+l),h.lookAt(ie),h.fov=W.lerp(h.fov,W.lerp(42,68,T),.04),h.updateProjectionMatrix(),F.rotation.y+=.0032,le.rotation.y-=.0014,de.rotation.y+=.011*t,ue.rotation.y=Math.sin(re*.35)*.04,sd(se,re,t),Fu(me,t,he),fe.rotation.y+=8e-5*t,pe.rotation.y+=45e-5*t,fe.material.uniforms.uTime.value=e,pe.material.uniforms.uTime.value=e*.72,pe.material.uniforms.uOpacity.value=W.clamp((T-.54)/.34,0,1)*.9,x.children.forEach(e=>{e.material.opacity=W.clamp((T-.035)/.18,.04,.22)}),h.updateMatrixWorld(),xe(),g.render(m,h),requestAnimationFrame(Ee)}ge(),Ee(),setTimeout(()=>{t.classList.add(`is-hidden`)},1350)})();